...
The Vol~III the K3 synthesis platonic chapter pins the core quantum-group deformation of
...
the K3 synthesis K3 bialgebra to produce
\[
...
\S\ref{sec:barconstr-supplement}.
\end{remark}
...
Lie-algebra structure emerges from the Hall Yangian. The the K3 synthesis
...
Cross-ref Vol.~I, \S\ref{sec:e1mkd-supplement}.
\end{remark}
