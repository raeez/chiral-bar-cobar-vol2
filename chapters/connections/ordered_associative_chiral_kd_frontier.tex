...
\begin{remark}[Abelian-at-Lie / non-abelian-at-vertex: DNA strand S7]
...
$\times E$ BKM frontier: DNA strand S1]
...
Wave-17 reconstituted architecture.
\end{remark}
...
$K^{\kappa_{\mathrm{ch}}} = 8$: DNA strands S2 and S8]
...
The ordered-associative chiral $K_d$ frontier at the Wave~13 K3 base
...
\begin{remark}[Wave~13 frontier $K_d$ and universal identity]
\label{rem:oackdf-DNA-2}
The universal identity $\hbar^2 \cdot K^{\kappa_{\mathrm{ch}}} = -1$
gives the Wave~13 $K_d$ frontier its root-of-unity specialisation:
