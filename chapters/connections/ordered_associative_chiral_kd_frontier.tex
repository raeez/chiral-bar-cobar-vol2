...
Mukai-conductor invariant $K^{\kappa_{\mathrm{ch}}} =
2 c_+(\mu(\mathrm{K3})) = 8$. The three faces of
$K^{\kappa_{\mathrm{ch}}}$ (Mukai / Humbert / Lusztig) are three independent verification
...
K3 elliptic-genus construction.
\end{remark}
...
deformation in this setting, not merely a root-multiplicity
denominator for the root multiplicities. The level parameter
in this presentation is the Mukai-conductor invariant
\[
 K^{\kappa_{\mathrm{ch}}}
 \;=\;
...
Together the Hall-double, cohomological-classification, and
Mukai-conductor faces exhibit the K3-frontier quantum-group deformation as \emph{uniquely
...
curve. Cross-ref core companion
