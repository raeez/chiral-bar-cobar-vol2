...
states; Theorem~H's bound $\dim \le 4$ (at generic level) is the bound on bulk
...
at the same conformal weight; the dual Heisenberg is
$\cH_{-k}$, see the base-case analysis below).
...
$k\ne 0$, the Verdier dual is $\cA^! = \cH_{-k}$: same
algebra, level negated.  (This is not the ``signed
reflection'' $\kappa\mapsto-\kappa$ of AP29 but the
boundary-dual Heisenberg at the opposite level; see
