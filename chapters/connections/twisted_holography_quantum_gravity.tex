...
dependency theorem (Theorem~\ref{V1-thm:thqg-dependency}).
...
(Definition~\ref{V1-def:thqg-standing-hypotheses}; in particular,
...
(which is false: AP203). Downstream readers should read
``by~MC5'' here as ``by the analytic HS-sewing lane of~MC5'', per
FM118 and the Vol~II bridge-table entry for the W-algebras row.
\end{remark}
