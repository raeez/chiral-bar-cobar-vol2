...
\index{central charge!$c_{4d}=26$, $c_{2d}=-312$ consistency}
...
-312,
\]
and the Koszul curvature entering the transgression class
$\Theta$ of Definition~\ref{def:tholog-strict-holographic-datum}
is governed on the chiral side by $c_{2d}=-312$ together with
...
The Wave~13 anomaly-completed topological holography at the K3 base
...
$(25/3)$-piece is the timelike-anomaly matching $c_{2d} = -312 = -3\cdot 8\cdot 13$
(factor $25/3$ consistent with $25\cdot 13 = 325$ vs $312$ modulo $13$
shift from Mukai-signature negative part $c_- = 20$)
