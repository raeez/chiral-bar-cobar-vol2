...
specific parent holomorphic-topological QFT. The the K3 synthesis
...
K3-Fock module under the Nekrasov the K3 synthesis discipline.
\end{definition}
...
on its ribbon structure). This cocycle is the umbral
...
$A_1$-theory on a K3 cycle. Part~(iii) is the K3 synthesis
...
K3 chiral bialgebra; \ClaimStatusConjectured, the K3 synthesis Cycle~4]
...
quantum group; \ClaimStatusProvedHere, the K3 synthesis Cycle~5]
...
$\hbar^2 = -1/8$; \ClaimStatusConjectured, the K3 synthesis Cycle~3]
...
(the K3 synthesis Beilinson--Etingof universal duality).
\end{conjecture}
...
gives $-1/8$ (Costello the K3 synthesis Cycle 5 AP-CY-W13-Cos-5).
\item \textbf{Lusztig $u_\zeta$ at $\ell = 8$.} Beilinson
the K3 synthesis route via Lusztig small quantum group at 8-th root
...
\label{rem:ch-DNA-1}
The the K3 synthesis celestial holography at the K3 base point is organised by
