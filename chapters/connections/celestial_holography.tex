...
$A_1$-theory on a K3 cycle. Part~(iii) is the Costello projective
twist of Remark~\ref{rem:celestial-hmkd-costello-twist}, with the
specific order-$6$ cocycle computed explicitly in the compute module.
\end{proof}
