...
\begin{quote}
\emph{Stable-graph summation $+$ logarithmic configuration geometry $+$ dg-shifted Yangian
line algebra $=$ modular holography.}
\end{quote}

\noindent
Three guiding questions organize the programme.
