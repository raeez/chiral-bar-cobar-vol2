...
$c_{\phi_{-2,1}}(1), c_{\phi_{-2,1}}(2), c_{\phi_{-2,1}}(3) = 0, 0, -8$
of \cite[Table 1]{EichlerZagier1985} \textup{(}the discriminants
$1, 2 \not\equiv 0, 3 \pmod 4$ are inadmissible, so the order-$1$ and
order-$2$ characteristics vanish, consistent with
$c_2 = 0$ of Proposition~\ref{V1-prop:bvbrst-2loop-obstruction}\textup{)};
