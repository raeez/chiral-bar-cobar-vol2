...
The HKR theorem identifies Hochschild cochains of a smooth commutative algebra with polyvector fields. In the dg setting here, the derived center of the boundary dg algebra is the shifted cotangent algebra of the derived boundary zero locus. Because the bulk critical locus is exactly that shifted cotangent, the bulk is recovered from the boundary algebra.
...
characteristic $\kappaChHodge(\cH_k)$, and the eta function
