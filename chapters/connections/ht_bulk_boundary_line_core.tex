...
weight-$(-2)$ index-$1$ weak Jacobi form and $[H_n]$ is the Humbert
divisor class of discriminant $n$
...
$c_4 = +12$, $c_7 = -39$, $c_8 = +56$ are the Fourier coefficients
$c_{\phi_{-2,1}}(-n)$ at $n = 3, 4, 7, 8$
...
$(-3)$-discriminant coefficient $c_{\phi_{-2,1}}(-3)$ multiplied by a
