...
\begin{corollary}[No modular-Koszul theory without loops (T15 (iii)); \ClaimStatusProvedHere]
...
\begin{theorem}[KZ-locus genus-zero boundary quantization; \ClaimStatusConditional]% label removed: thm:conditional-tree
