...
\cite{KZ25}), $\hypStokes$ (Stokes-data choice on the Forsythe--Mukai
...
Construction Problem~3 (CLAUDE.md~\S9). Theorem statements that depend
on the all-loop quantum lift carry the four $\hyp$ tags; the genus-zero
...
\cite{KZ25}; Stokes-data choice on the Forsythe--Mukai compactification;
