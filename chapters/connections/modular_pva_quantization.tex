...
\label{rem:mpvaq-1}
At the K3 base, modular PVA quantisation pairs with the Siegel-elliptic
...
$\lambda_p(\Delta_{10}) = a_p(\Delta_{E_6}) + p^8 + p^9$). The
root-of-unity specialisation uses the K3 conductor
\[
...
space $\mathbb H_2$ with the Gritsenko--Nikulin order-two multiplier
on $\mathrm{Sp}_4(\mathbb Z)$, is a Siegel modular form of weight
\[
w_{\mathrm{Sieg}} \;=\; 5
\]
