...
\ClaimStatusProvedHere]
\label{prop:mpvaq-wave16-siegel-vs-elliptic}
...
Remark~\ref{rem:anomtop-wave15-ceff-bps}), and the correct
...
\label{rem:mpvaq-wave16-obstruction}
...
$S_2 = -107$ of Vol~I
Proposition~\ref{prop:stqp-wave15-312-factor} (retracted from the
