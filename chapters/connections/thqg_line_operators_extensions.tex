...
\label{sec:lineop-ext-wave13-DNA}

\begin{remark}[Line-operator extensions at the $24$-punctured Wave~13 base]
\label{rem:lineop-ext-DNA-1}
The line-operator extensions of this chapter reach their K3-canonical
realisation in the Wave~13 class-$\mathcal S$ $A_1$-on-$\Sigma_{0,24}$
...
the $\hbar\to 0$ classical limit of the Wave~13 coproduct
$\Delta_{\mathrm{Wave13}}:\mathbf H_{\Delta_5}\to\mathbf H_{\Delta_5}\otimes\mathbf H_{\Delta_5}$
