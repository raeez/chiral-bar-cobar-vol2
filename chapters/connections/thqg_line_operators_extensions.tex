...
\begin{remark}[Line-operator extensions at the $24$-punctured the K3 synthesis base]
...
$\Delta_{\mathrm{the K3 synthesis}}:\mathbf H_{\Delta_5}\to\mathbf H_{\Delta_5}\otimes\mathbf H_{\Delta_5}$
