...
For $\cA=\cH_k$: $C^*(\cH_k,\cH_k)$ is generated over the
unit by the Heisenberg level-deformation class
$[\partial_k\alpha]\in H^2(C^*(\cH_k,\cH_k))$ (the
$2$-cocycle recording the variation of the OPE coefficient
under $k\to k+\varepsilon$; \Cref{comp:bulk-heisenberg}). The
cup product is trivial; the Gerstenhaber
