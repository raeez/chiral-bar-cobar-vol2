...
\begin{remark}[Wave-13 DNA: CY-$2$ input shifts the HKR bar-cobar
...
(Vol~III, Part~\ref{part:frontier}, Wave-13 S3), the
...
\begin{remark}[Wave-13 DNA: bi-based Ran-space factorisation on the
...
$24$-puncture configuration of Wave-13 S3; nearby-cycles at each node
...
Wave-13 S4 \emph{bi-base factorisation identity}
...
\begin{remark}[Wave-13 DNA: Chiral Hochschild Trinity at the K3
...
The Universal $\Phi$-Trace Identity of Wave-13 S11
...
Wave-13 S11 realised as the degree-$0$ (conductor) versus
...
\begin{remark}[Wave-13 DNA: Igusa $\Delta_5$ as the
...
Wave-13 S2; compare upstream inscription
...
\begin{remark}[Wave-13 DNA: $K^{\kappa_{\mathrm{ch}}}=8$ on the
...
\begin{remark}[Wave-13 DNA: Hall--Drinfeld double versus Drinfeld
...
Vol~III Wave-13 taxonomy (Vol~III Part~\ref{part:frontier}, Wave-13
...
\item \emph{Hall--Drinfeld double}: the CY-$2$ specialisation of~(c)
 ...
 (compare Vol~III Part~\ref{part:frontier}, Wave-13 S1), and the
...
\begin{remark}[Hochschild concentration at the Wave~13 K3 base point]
\label{rem:hoch-DNA-1}
The Vol~I Theorem~H (Hochschild concentration in a single degree)
refines at the Wave~13 K3 base point to:
...
\begin{remark}[Class-$\mathcal S$ Hochschild trace at $c_{2d} = -312$]
\label{rem:hoch-DNA-2}
The class-$\mathcal S$ Hochschild trace of $\mathcal T[A_1,\Sigma_{0,24}]$
at the Wave~13 base point gives central charge
$c_{2d} = -12 c_{4d} = -12\cdot 26 = -312$ via the Chacaltana--Distler
evaluation $c_{4d}(A_1,\Sigma_{g,n}) = (12(g-1)+7n)/6|_{(0,24)} = 26$,
with the Mukai signature ratio $c_{2d} = -c_-(c_-/4+1)\cdot 2 - 2c_{4d} = -52-260$
factoring $312 = 52 + 260$. The Hochschild concentration thus matches
the class-$\mathcal S$ Virasoro shadow \cite{Gaiotto2009,ChacaltanaDistler2010}.
