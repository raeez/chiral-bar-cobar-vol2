...
strategy at arity three and above.
...
not $k/2$). All higher-arity invariants vanish by pointwise freeness.
Hence
\begin{equation}
...
obstructed at arity three and above. A direct calculation on the
