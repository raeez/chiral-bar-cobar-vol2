...
The identification is (T18 convention: the Tamarkin column is
T18(i) chiral derived centre $Z^{\mathrm{der}}_{\mathrm{ch}}(\cA)$;
the Swiss-cheese column is T18(iii) 3d HT bulk; T18(ii) RT topological
bulk does not appear in this identification):
\begin{center}
...
(T18 convention: this theorem identifies T18(iii) 3d HT bulk local
operators with T18(i) chiral derived centre
$Z^{\mathrm{der}}_{\mathrm{ch}}(A_{\partial})=C^\bullet_{\mathrm{ch}}(A_{\partial},A_{\partial})$.)
...
\label{thm:bulk-CHC}
(T18 convention: T18(iii) 3d HT bulk observables $\mathsf{Obs}_{\mathrm{bulk}}$
on the left; T18(i) chiral Hochschild cochains on the right.)
...
Remark~\ref{rem:bar-cobar-1-igusa-gauge}), the classification of
...
bookkeeping of Remark~\ref{rem:hoch-CY2-K3-shift}. At the
