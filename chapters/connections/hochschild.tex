...
\subsection{\texorpdfstring{Tamarkin's Deformation Theory and $*$-Lie Algebras}{Tamarkin's Deformation Theory and star-Lie Algebras}}
...
(Theorem~\ref{V1-thm:kl-bar-cobar-adjunction}, Step~4 purity) from
...
proved implication on the admissible locus of
Theorem~\ref{thm:holographic-recon-class-m}: the Costello--Gaiotto
$3$d HT theory, Arakawa $C_2$-cofiniteness, and the DS--Hochschild
bridge (Theorem~\ref{thm:ds-hochschild-bridge}) give
the identification
...
Chapter~\ref{V1-sec:thqg-open-closed-realization} line~1932 on the
