...
non-evaluation $R$-matrix.  The construction of this resolution
and the verification that it produces the quantum group
$R$-matrix (completing the DK ladder of
Remark~\ref{rem:dk-kontsevich}) remain open beyond type~$A$.
