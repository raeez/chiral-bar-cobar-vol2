...
% label removed: sec:cbt-ordered-all-degree
...
% label removed: cor:cbt-all-degrees-nonzero
\ClaimStatusProvedHere
For every $n\ge3$,
\[
...
The all-degree formulas were proved for the canonical transferred model. Which of these define genuine gauge-invariant higher obstructions, and which are artifacts of the preferred deformation retract?
