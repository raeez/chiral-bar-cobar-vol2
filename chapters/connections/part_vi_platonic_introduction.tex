...
% chapters where each closure is stated).
%
...
$\Einfty$-topological endpoint appears as the final section
...
theorems. Each is proved in a dedicated chapter; the proofs are
...
Each of the nine FM closures stated in
