...
\label{sec:specbraid-ext-wave13-DNA}

\begin{remark}[Spectral braiding on $\mathbf H_{\Delta_5}$]
\label{rem:specbraid-ext-DNA-1}
The spectral braiding extensions developed here for twisted HT quantum
gravity specialise, at the Wave~13 K3 base point, to the Siegel-elliptic
...
to the Wave~13 Siegel-elliptic dynamical braiding is effected by the
CY-to-chiral functor $\Phi$ pulling back the trigonometric data to the
Siegel-modular setting. Cross-ref Vol.~III,
