...
\begin{theorem}[Canonical coderivation Maurer--Cartan class]
...
\begin{theorem}[Residue splitting theorem]
...
\begin{theorem}[The explicit small model]
...
\begin{theorem}[Maurer--Cartan dictionary]
...
\begin{proposition}[First and second obstruction classes]
...
\begin{theorem}[The first genuinely planted-forest cubic obstruction]
