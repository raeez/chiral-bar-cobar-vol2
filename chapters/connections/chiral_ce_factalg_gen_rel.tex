...
$\hbar^n\cdot K^{\kappaChHodge}_n = (-1)^n$
...
$\hbar^n K^{\kappaChHodge}_n = (-1)^n$ at
$n = 2, K^{\kappaChHodge} = 8$ forces
...
witness; at
$n = 2, K^{\kappaChHodge} = 8$, giving
$\hbar^2 = -1/8$; at $n = 3, K^{\kappaChHodge}_3 = 50$ (type
...
Theorem~\ref{thm:ch-ce-topologization-E3-top}).
\item\label{id:15}
$\hbar^n\cdot K^{\kappaChHodge}_n = (-1)^n$ under the
