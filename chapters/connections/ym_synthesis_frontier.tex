...
The Hilbert-screening bridge datum should be the map from the instanton-completed derived center
to the spectral gap criterion.
The visible-center collapse, the statement that only the scalar (trivial) component
of the derived center survives screening, should be the algebraic incarnation of mass gap domination:
one expects all non-trivial representations of the convolution algebra to be gapped, and
the vacuum sector to be separated from the first excited state by $m > 0$.
\end{remark}
...
the mass gap should be the spectral gap of the Steinberg correspondence.
