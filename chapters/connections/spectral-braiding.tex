...
\item \emph{Complementarity.}
 $\kappa(\cA) + \kappaChHodge(\cA^!) = 0$ for Kac--Moody and free-field algebras
...
(iv): Complementarity $\kappa(\cA) + \kappaChHodge(\cA^!) = 0$ for KM and free-field algebras
...
K3 target package produced by the super-Etingof--Kazhdan quantisation
...
part of the target datum. Cross-ref Vol.~III
...
rank-$24$ evaluation block, with $8 = K^{\kappa_{\mathrm{ch}}}$ the
...
\cite{Lusztig1990,Bruinier2002}. Cross-ref
Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}.
\end{remark}
...
series \cite{PasolZagier2013,EtingofSchiffmann1998}. On the
...
quantisation plus Hall--Borcherds recognition problem. Cross-ref Vol.~III
Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}
...
of this block \cite{Molev2007}. If the finite Hall--Borcherds
...
the full centre. Cross-ref Vol.~III
Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}
