...
\end{equation}
recovering Theorem~\ref{V1-thm:vir-all-genera}.
...
Theorems~\ref{V1-thm:topological-regime}
and~\ref{V1-thm:gravitational-regime} to $\cA = \mathrm{Vir}_c$ with
$\kappa = c/2$. The free energy
formula~\eqref{V1-eq:g9-partition-topo} is Theorem~\ref{V1-thm:vir-all-genera}.
...
Proposition~\ref{V1-prop:vir-complementarity}: $F_g(\mathrm{Vir}_{26}) +
...
Theorem~\ref{V1-thm:vir-all-genera} and
...
and~\ref{V1-thm:vir-self-duality-c13}, together with
Proposition~\ref{V1-prop:vir-complementarity}.
\end{proof}
...
Clifford completion as an algebraic dichotomy at $c=26$. We now
upgrade this observation to a computation: the Clifford degeneration
...
\texttt{celestial\_holography\_core.tex}), the $c=26$
