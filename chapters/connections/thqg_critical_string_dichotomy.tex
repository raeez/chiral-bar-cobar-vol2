...
\begin{remark}[Critical string dichotomy and the Wave~13 $c = -312$]
\label{rem:csd-DNA-1}
The critical-string dichotomy, in its $c_{\mathrm{crit}} = 26$ bosonic
and $c_{\mathrm{crit}} = 15$ superstring forms, admits a Wave~13 refinement
through the class-$\mathcal S$ $A_1$-on-$\Sigma_{0,24}$ VOA of central
charge
\[
c_{\mathrm{Wave13}} \;=\; c_{2d} \;=\; -2\cdot 26 - 260 \;=\; -312,
\]
...
$\mathfrak{su}(2)^{24}$-flavour. This central charge is the Wave~13
echo of the bosonic-string critical dimension: $c_{\mathrm{Wave13}} = -312
