...
\subsection{Low-mode coefficient targets}
\label{subsec:low-mode-coefficient-targets}

This subsection isolates the exact low-mode coefficient identities
proved below from Zeng's explicit $A_\infty$ formulas.

\begin{remark}[Low mixed cubic reflection target]
...
\begin{remark}[Explicit charged quartic jet target]
...
\begin{remark}[First mixed bubble coefficient target]
...
force this reduction. The exact rational values recorded above are
proved in Theorems~\ref{thm:charged-quartic-coefficient}
and~\ref{thm:first-mixed-bubble-coefficient}.
\end{remark}

\subsection{Structural derivations and explicit evaluation of the low-mode data}
\label{subsec:low-mode-data-derivation}

We first prove the structural parts of
Remarks~\ref{rem:low-mixed-cubic-reflection-target},
\ref{rem:explicit-charged-quartic-jet-target}, and
\ref{rem:first-mixed-bubble-coefficient-target}, then reduce the
remaining numerical evaluations to explicit finite integrals over
...
This proves the reflection identity of
...
The three low-mode values are established.
...
\]
resolving the three targets of
\S\ref{subsec:low-mode-coefficient-targets}.
\end{remark}
