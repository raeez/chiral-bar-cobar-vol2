...
\begin{proof}
Both expressions follow from unraveling the homotopy transfer formula: at degree $k$, the
...
product of two degree-$3$ trees glued along the internal edge.
\end{proof}
...
\item $Q_{110}=Q_{011}=-1/15$
 (Theorem~\ref{thm:charged-quartic-coefficient}) is computed from the degree-$4$
