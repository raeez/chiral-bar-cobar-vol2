...
cohomology.  Each vertex of the triangle is
accessible:
\begin{enumerate}[label=\textup{(\roman*)},nosep]
...
additional projection.  Thus the agreement of the three routes is
...
\item $\mathcal{A}^!_{\mathrm{line}}=Y_\hbar(\mathfrak{g})$: the celestial
