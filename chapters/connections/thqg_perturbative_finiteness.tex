...
\end{equation}
On the uniform-weight lane (Vol~I, Definition~\ref*{def:scalar-lane}),
...
\index{monster CFT}
For the monster CFT with $c = 24$ (the Frenkel--Lepowsky--Meurman moonshine module $V^\natural$), $\kappa(V^\natural) \approx 12$ (orbifold estimate; not computed directly from the genus-$1$ bar complex of $V^\natural$; AP48):
\begin{align*}
F_1 &= 12/24 = 1/2, \\
