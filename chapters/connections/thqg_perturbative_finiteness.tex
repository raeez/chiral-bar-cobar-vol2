...
Z \;=\; \frac{3\ell}{4G}\left(1 + \frac{G}{36\ell} + \frac{7G^2}{12960\ell^2} + O(G^3/\ell^3)\right).
\end{equation}
\end{proposition}
...
The propositions below establish this bound for the low-degree
amplitudes and isolate the precise obstacle at general degree.
...
grow monotonically with $c$. The asymptotic-ratio band
