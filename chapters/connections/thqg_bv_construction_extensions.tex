...
\cite{CG16,CG21}\textup{)} for a $\cD$-module structure on
...
weight-completed bar complex \textup{(}conilpotency fails for
class-M algebras in the raw direct sum; the BD-factorization
structure requires the limit ambient, cf.\ the $L_0$-weight
completion of Vol~I\textup{)}.
\end{enumerate}
...
\label{sec:bvconstr-ext-wave13-DNA}

\begin{remark}[BV construction on $\mathbf H_{\Delta_5}$]
\label{rem:bvconstr-ext-DNA-1}
The BV construction applied to the Wave~13 K3 bialgebra produces a
homotopy-BV algebra
$(\mathbf H_{\Delta_5},\; \Delta_{\mathrm{BV}},\; \{-,-\}_{\mathrm{BV}},\; \cdot)$
with BV Laplacian
\[
\Delta_{\mathrm{BV}}^{\mathrm{Wave13}} \;=\; \Delta_{\mathrm{Hall}} \;+\; \hbar\, \Delta_{\mathrm{Sieg}} \;+\; \hbar^2\, \Delta_{\Phi_{10}/\eta^{24}},
\]
...
recovers the Wave~13 Poisson bracket $\{-,-\}_{\mathrm{Sieg}}$ at
$\hbar\to 0$ (Vol.~II, \S\ref{sec:modpva-ext-wave13-DNA}), and deforms
