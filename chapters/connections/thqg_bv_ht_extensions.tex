...
Three conjectures: Conjecture~\ref{rem:bar-cobar-ht-boundary} (bar-cobar from HT
...
Conjecture~\ref{rem:bar-cobar-ht-boundary} acquires a sharp formulation once the boundary data is specified
family by family:
