...
$\kappa = \kappaChHodge(\cA)$, the BV partition function at genus $g$ is
...
dual Hodge bundle determined by $\kappaChHodge(\cA)$, and the partition
...
\]
evaluated on an HT Lagrangian in the recognised target package.  Its
