...
arity $r\ge 2$: the curvature~$\kappa(\cA)$ at arity~$2$,
...
strict Yangian $Y_z^\hbar(\mathfrak{sl}_2)$; on the evaluation locus,
...
On the Yangian side ($Y_z^\hbar(\mathfrak{sl}_2)$ as line-operator
algebra), the anomaly-completed Yangian
$Y_{\hbar,\Theta} := (Y_z^\hbar(\mathfrak{sl}_2))_\Theta$
