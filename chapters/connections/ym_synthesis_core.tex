...
proved in Volume~I to $(\cA_{\cB}, \cA_{\cB}^!)$.
\end{proof}
...
\begin{proof}
By the deformation-obstruction dictionary, primary obstructions to extending a first-order deformation lie in $HH^{3}_{\mathrm{chiral}}(\cA_{\cB})$.  Apply the main Koszul--Hochschild comparison theorem of Volume~I with $n=3$ to obtain
\[
