...
We assume the following results.
...
The K3 ordered-associative chain at $\hbar^2 = -1/8$ lives on
...
(hep-th/0701156). Cross-ref Vol.~III
Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}.
\end{remark}
...
(\cite[Prop.~5.1]{Bruinier2002}). The finite Heegner-label comparison
against Eguchi--Ooguri--Tachikawa Table~1 gives the present numerical
check of the leading multiplicities.
...
\item \textbf{Derived $E_2$ via factorisation on K3}: the K3 factorisation
 structure of $\mathbf H_{\Delta_5}$ in Vol.~III lifts the
...
The K3 chiral bialgebra extends off the self-dual $\Omega$-locus as a
...
$\Delta_5$ output. The operadic level is native $E_1$ on the
curve~$E$ and derived $E_2$ on the K3 surface; the ordered-associative
Koszul-duality of this chapter works at native $E_1$. Bruinier
Prop.~5.1 leading multiplicities at the self-dual slice match the five
Heegner labels of Eguchi--Ooguri--Tachikawa Table~1.
\end{remark}
