...
(Corollary~\ref{cor:classical-ybe}); and the Yangian $Y_z^\hbar(\mathfrak g)$
...
$\cA^!=Y_z^\hbar(\mathfrak g)$ at deformation parameter
...
\in\operatorname{End}(V)\otimes Y_z^\hbar(\mathfrak g)[\![u^{-1}]\!]$
...
$\Omega=e\otimes f+f\otimes e+\tfrac12 h\otimes h$
(the Casimir), and the Yangian $Y_z^\hbar(\mathfrak{sl}_2)$
