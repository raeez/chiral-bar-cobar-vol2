...
\end{enumerate}
The $E_1$ five main theorems (Vol~I, Chapter~\ref{chap:e1-modular-koszul}) are the ordered analogues of Theorems~A--H, with the associative bar replacing the commutative bar and planar forests replacing stable graphs.
\end{construction}
