...
Jacobi identity for the Virasoro $\lambda$-bracket. Verification:
\[
\{T{}_\lambda\{T{}_\mu T\}\}
- \{T{}_\mu\{T{}_\lambda T\}\}
...
\begin{proof}
Verification: each piece of structure in
...
\begin{proof}
Verification: the three axioms of a factorisation quantum group (Definition~\ref{def:factorisation_QG}).
...
Verify: $r^{\Sigma_g}$ satisfies the classical
