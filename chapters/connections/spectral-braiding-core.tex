...
\begin{description}
\item[Provenance (a), $E_\infty$-chiral \emph{(derived from OPE)}.] For a vertex algebra $\cA$ (KM at non-critical level, Virasoro, Heisenberg, $W_N$, lattice VOAs --- all $E_\infty$-chiral per V2-AP1), the classical $r$-matrix is extracted as the binary collision residue
\[
