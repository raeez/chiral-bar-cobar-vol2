...
$\kappa(\cA^!) = -\kappaChHodge(\cA)$. The complementarity
...
The anti-symmetry $\kappa(\cA^!) = -\kappaChHodge(\cA)$ holds for
...
\item \emph{Complementarity.}
 $\kappaChHodge(\cA) + \kappa(\cA^!) = 0$ for Kac--Moody and
...
$\kappaChHodge(\cA)+\kappa(\cA^!)=0$ in the Kac--Moody trace-form case; Vol~I, Theorem~C
specialized to Kac--Moody and free-field algebras),
the closed-color curvatures
$\kappaChHodge(\cA) \cdot \omega_g$ and
$\kappa(\cA^!) \cdot \omega_g = -\kappaChHodge(\cA) \cdot \omega_g$
...
The K3 object entering this section is first a target package
...
spectral datum inside the Vol~III target package
...
\begin{remark}[Spectral braiding on the gated K3 target package]
