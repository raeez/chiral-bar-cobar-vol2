...
$\Delta_5$. This is the spectral-braiding datum of the Vol~III K3 chiral
...
$\widetilde{\Phi}^{\mathrm{Sieg\text{-}Bor}}_{\mathrm{Sp}_4}[\Phi_{10}^{\mathrm{un}}/\eta^{24}]$ satisfies the
pentagon at order $\hbar^{\leq 3}$ with coboundary
$\phi^{(3)} = \zeta(3) c_{\mathrm{symm}} + (25/3) c_{\mathrm{timelike}} + (\Phi_{10}^{\mathrm{un}}/\eta^{24}) c_{\Phi_{10}}$,
