...
Lemma~\ref{V1-lem:arity-cutoff} ensures that the series terminates
...
homotopy $\hCont$ of
Theorem~\textup{\ref{V1-thm:thqg-VII-contracting-homotopy}},
...
Since $H^2 = 0$
(Theorem~\ref{V1-thm:thqg-VII-contracting-homotopy}(ii)),
...
(Proposition~\ref{V1-prop:thqg-VII-genus1}). The solution is
$\Theta^{(1)} = -\hCont(\Ob_1)$ by
Construction~\ref{V1-constr:thqg-VII-mc-recursion}.
...
From Proposition~\ref{V1-prop:thqg-VII-genus2}:
...
three shells (Proposition~\ref{V1-prop:thqg-VII-genus2}) are:
\begin{align}
\Theta^{(2)}_{\mathrm{loop}^2}
...
completeness of
Remark~\ref{V1-rem:thqg-VII-hbar-topology}: the
...
\item \emph{Completeness.} The MC recursion
 \textup{(}Construction~\textup{\ref{V1-constr:thqg-VII-mc-recursion})}
...
(Theorem~\ref{V1-thm:thqg-VII-ss-convergence}).
...
(Proposition~\ref{V1-prop:thqg-VII-genus1}) is:
...
(Proposition~\ref{V1-prop:thqg-VII-genus2}) is:
...
(Proposition~\ref{V1-prop:thqg-VII-genus3}) is:
...
(Proposition~\ref{V1-prop:thqg-VII-genus4}) is:
...
(\S\ref{V1-sec:thqg-perturbative-finiteness}): the graph
...
Proposition~\ref{V1-prop:thqg-VII-genus1-solution},
...
(Construction~\ref{V1-constr:thqg-VII-mc-recursion}). Gauge
...
\item The genus spectral sequence degenerates at $E_1$
 \textup{(}Corollary~\textup{\ref{V1-cor:thqg-VII-gaussian-degeneration})},
...
as in Theorem~\ref{V1-thm:thqg-VII-recursion-closed}.
\end{proof}
...
\item the MC recursion
 (Construction~\ref{V1-constr:thqg-VII-mc-recursion}), which
...
\item the genus spectral sequence
 (Theorem~\ref{V1-thm:thqg-VII-genus-ss}), which organizes
 the computation.
\end{enumerate}
...
spectral sequence
(Corollary~\ref{V1-cor:thqg-VII-gaussian-degeneration},
Proposition~\ref{V1-prop:thqg-VII-mixed-nondegeneration},
Theorem~\ref{V1-thm:thqg-VII-ss-shadow-obstruction}).
...
(Theorem~\ref{V1-thm:thqg-VII-g-loop-amplitude}). There is no
...
(Lemma~\ref{V1-lem:arity-cutoff}) bounds the number of
