...
\label{sec:modbootstrap-wave13-DNA}

\begin{remark}[Siegel modular $\Delta_5$ bootstrap and four duality frames]
\label{rem:modbootstrap-DNA-1}
The modular bootstrap for twisted HT quantum gravity, at the Wave~13
...
\S\ref{sec:line-operators-wave13-DNA}):
\begin{itemize}
...
Wave~13 bar--cobar adjunction on $\mathbf H_{\Delta_5}$ -- the
modular-bootstrap condition is exactly the closure of the bar differential
$d_B^2 = 0$, as decomposed in Vol.~II, \S\ref{sec:bar-cobar-review-wave13-DNA}.
\end{remark}

\begin{remark}[$M_{24}$ mock modular characters and the $24$-fold multiplicity]
\label{rem:modbootstrap-DNA-2}
...
lifts of Cheng--Duncan--Harvey 2014 umbral mock theta series. The Wave~13
