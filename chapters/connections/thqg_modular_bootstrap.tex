...
$\mathrm{THH}$ of
\S\ref{sec:thqg-hochschild-stratification}; AP160 discipline).
...
Chapter~\ref{ch:thqg-climax}: the boundary chiral algebra
...
boundary $\Sigma_2$, as inscribed below.
...
$c_{2d} = -214$ of
Vol~I Proposition~\ref{prop:stqp-312-factor}, the
...
Vol~I Proposition~\ref{prop:stqp-signature}, with
...
The Gram matrix of
Vol~I Proposition~\ref{prop:stqp-signature} on the real-root
...
Gritsenko--Nikulin 1998 \emph{Amer.~J.~Math.}~120 \S 3.5 and
Vol~I Proposition~\ref{prop:stqp-signature}, the first ten
...
\S\ref{sec:stqp-unitarity} ensures semisimple unitary
...
(iv) Vol~I Proposition~\ref{prop:stqp-312-factor}
...
(v) Vol~I Remark~\ref{rem:stqp-1} (Humbert-intersection count).
\end{proof}
