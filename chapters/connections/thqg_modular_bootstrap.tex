...
\item $r_{\max} = 2$ \textup{(}Gaussian\textup{)}: the bulk
  gravity is \emph{free at the arity level}: the higher-arity
  shadow tower vanishes, and the genus
  spectral sequence collapses at $E_1$.  Example: Heisenberg
  $\cH_k$ (free boson in the bulk).  On the proved scalar lane
  this further gives a scalar Fredholm determinant controlled
  by~$\kappa$.
