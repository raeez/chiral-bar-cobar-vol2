...
celestial holography from bar--cobar data. We now state the universal
theorem which subsumes them: \emph{every $4$-dimensional holomorphic--topological
...
\end{itemize}
\item The shadow class of $\cA^{\mathrm{cel}}$ (in the G/L/C/M classification
of Part~\ref{part:mod-sc}) determines the physical regime of $T_4$:
\begin{itemize}
...
(iv) The G/L/C/M classification is that of Part~\ref{part:mod-sc};
...
(AP: \emph{pole-order dichotomy}, V2-AP24): the bar differential has
...
(\S~\ref{subsec:tholog-coda} in \texttt{anomaly\_completed\_core.tex})
