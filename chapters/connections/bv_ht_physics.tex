...
\emph{Homotopy template} (Convention~\ref{conv:hms-levels}): Type~VII (physics-dictionary).  MC5 is proved at all genera in Volume~I; the remaining obstacle is the gauge-theoretic comparison (physics input).
\end{remark}
