...
$\Omega/z$ of $\mathfrak{gl}_K$
(AP126: $\Omega/z$ denotes the Yangian $R$-matrix in the Costello double-loop
convention at unit level; the level-prefixed form $k\,\Omega/z$ applies in
the affine Kac--Moody specialization, cf.\ Theorem~\ref{thm:YBE}).  In Costello's terminology, it
...
(Vol~I, Proposition~\ref*{V1-prop:shadow-formality-low-arity}),
