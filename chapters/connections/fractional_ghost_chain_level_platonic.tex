...
\textup{(}e.g.,
\cite[the fractional-ghost reconstitution scope restriction L15-19]{test-e3-topological-ds-general-docstring}\textup{)}
...
\end{itemize}
This remark is inscribed solely as the wave-14 anchor; the the fractional-ghost reconstitution
