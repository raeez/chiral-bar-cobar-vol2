...
claim that Theorem~\ref{thm:E3-topological-DS-general} extends to non-principal
...
Theorem~\ref{thm:E3-topological-DS-general} is the statement for
...
$E_{n}$-operadic circle (Vol~I CLAUDE.md, section on the $E_n$ operadic
