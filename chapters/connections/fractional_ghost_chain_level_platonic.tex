...
\end{enumerate}
All three recover the BP central charge
$c^{\mathrm{BP}}(k) = -\frac{2(k+3)(3k+1)}{k+3}$ and the
...
BP as a sub-VA of three screened free bosons with explicit central
charge; the Feigin--Frenkel intersection equips the Koszul-dual
...
at all~$k$; the $\Ethree$-topological data agree at $k = 0$ by
