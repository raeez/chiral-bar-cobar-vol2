...
\begin{maintheorem}[Affine half-space BV quantization]\label{rem:affine-half-space-bv}
\ClaimStatusProvedHere.
...
\begin{proof}
Theorem \ref{rem:affine-half-space-bv} gives a renormalized BV quantization to all orders.  One-loop exactness
...
Theorem \ref{rem:affine-half-space-bv} then identifies $K_{\mathrm{eff}}$ with the one-loop shifted level.
\end{proof}
...
$\omega_{\mathrm{KM}}$.  Theorem \ref{rem:affine-half-space-bv} further shows that the quantum theory is one-loop exact.
...
the one-dimensional level-shift line.  Theorem \ref{rem:affine-half-space-bv} shows that the complete quantum
...
(Theorem~\ref{rem:affine-half-space-bv})
...
Theorem~\ref{rem:affine-half-space-bv}), and $\delta_N(V)$ is the
...
Theorem~\ref{rem:affine-half-space-bv}.  The corrections $\delta_N$
...
\emph{exact} by Theorem~\ref{rem:affine-half-space-bv}\textup{(2)}.
...
\textup{(}Theorems~\textup{\ref{rem:affine-half-space-bv}}
...
The affine half-space theorem (Theorem~\ref{rem:affine-half-space-bv})
