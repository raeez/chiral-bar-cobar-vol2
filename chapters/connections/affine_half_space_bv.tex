...
\begin{theorem}[Polynomial half-space BV theorem for Poisson vertex sigma models under the KZ SDR hypothesis]\label{thm:general-half-space-bv-preview}
...
After the renormalized BV data have been constructed, the reflected weight
...
$G$-equivariantly. In the present setting the relevant target action is the
formal additive holomorphic-translation action generated by $H$
