...
torsion. Vol~I inscribes the chain-level banding cocycle
...
As $n\to\infty$, the absolute value $|c_{\phi_{-2,1}}(-n)|$ grows as
$\exp(\pi\sqrt{n})$ \textup{(}Gritsenko--Nikulin circle method;
