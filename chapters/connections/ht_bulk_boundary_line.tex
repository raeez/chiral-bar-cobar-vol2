...
$\Theta_{g,n}^{\cT;B}$.  In favorable cases---when the tautological
action factors through a finite-rank CohFT---this should produce
topological-recursion-type identities for modular holographic
amplitudes.
\end{conjecture}
