...
of dimension $20$, and the Wave~13 symplectic form on the $\mathbf H_{\Delta_5}$-module
category is
\[
\omega_{\mathrm{Wave13}} \;=\; \mathrm{Im}\bigl(\langle-, -\rangle_{\mathrm{Muk}}\bigr)\bigr|_{V_+\otimes V_-}\;\in\; \Omega^2(\mathrm{Ran}(E^{\mathrm{nod,sm}}_{24})),
\]
a symplectic form of rank $8 = \dim(V_+)\cdot 2 = 2\cdot c_+$. This is
the Mukai-pairing face of the universal $8$ (Vol.~I,
\S\ref{sec:chiralmod-wave13-DNA}): the symplectic-polarization rank
$= K^{\kappa_{\mathrm{ch}}} = 8$. The Wave~13 geometric quantisation
of $\omega_{\mathrm{Wave13}}$ recovers $\mathbf H_{\Delta_5}$ as the
Hilbert space of polarised sections at the Lusztig specialisation
