...
the K3 synthesis base, the Mukai pairing on
...
category is
\[
\omega_{\mathrm{the K3 synthesis}} \;=\; \mathrm{Im}\bigl(\langle-, -\rangle_{\mathrm{Muk}}\bigr)\bigr|_{V_+\otimes V_-}\;\in\; \Omega^2(\mathrm{Ran}(E^{\mathrm{nod,sm}}_{24})),
\]
...
$= K^{\kappa_{\mathrm{ch}}} = 8$. The the K3 synthesis geometric quantisation
of $\omega_{\mathrm{the K3 synthesis}}$ recovers $\mathbf H_{\Delta_5}$ as the
