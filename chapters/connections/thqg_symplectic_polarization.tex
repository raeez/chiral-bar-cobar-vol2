...
AdS$_3$/CFT$_2$ dictionary, modular invariance, vacuum dominance, and
saddle analysis.
...
$\kappaChHodge(\cA) + \kappa(\cA^!) = 0$ for Kac--Moody and free-field algebras,
but $\kappaChHodge(\cA) + \kappa(\cA^!) = 13$ for Virasoro and
