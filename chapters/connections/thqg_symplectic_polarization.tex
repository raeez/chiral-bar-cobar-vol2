...
The complementarity theorem (Theorem~\ref{V1-thm:quantum-complementarity-main})
...
Proposition~\ref{V1-prop:thqg-III-ambient-properties}(ii) and
...
Construction~\textup{\ref{V1-constr:thqg-III-verdier-involution}}
satisfies:
...
Proposition~\ref{V1-prop:thqg-III-mc-compatibility} is the
...
Since $\sigma^2 = \id$
(Proposition~\ref{V1-prop:thqg-III-involutivity}(a)) and we
...
of $\sigma$
(Construction~\ref{V1-constr:thqg-III-verdier-involution}),
...
(Lemma~\ref{V1-lem:thqg-III-nondegeneracy}).
...
(Proposition~\ref{V1-prop:thqg-III-kontsevich-pridham}),
...
By Proposition~\ref{V1-prop:thqg-III-involutivity}(b), the pairing
...
\item \emph{Nondegeneracy:} the holographic Verdier pairing
  ...
  \textup{(}Lemma~\textup{\ref{V1-lem:thqg-III-nondegeneracy})}.
\end{enumerate}
Then for $g \ge 2$:
...
\textup{(}Definition~\textup{\ref{V1-def:thqg-III-shifted-symplectic})}.
...
(Definition~\ref{V1-def:thqg-III-holographic-pairing}) is a
nondegenerate symmetric pairing of degree $-(3g-3)$ on the
cochain complex $\mathbf{C}_g(\cA)$.  By
Example~\ref{V1-ex:thqg-III-linear-shifted} (linear shifted
...
(Definition~\ref{V1-def:thqg-III-ptvv-lagrangian}) for
...
\mathbf{Q}_g(\cA^!)$
(Theorem~\ref{V1-thm:thqg-III-eigenspace-decomposition}), the
quotient is
...
(\S\ref{V1-subsec:thqg-III-standard-landscape}).  The C1
...
\textup{(}Theorem~\textup{\ref{V1-thm:thqg-III-bv-lagrangian})}
...
Definition~\textup{\ref{V1-def:nms-arity-r-shadow-jet}}.
...
Definition~\ref{V1-def:nms-arity-r-shadow-jet}.  The explicit
formula \eqref{V1-eq:thqg-III-shadow-projection} is
equation~\eqref{V1-eq:nms-arity-r-shadow-jet}.
\end{proof}
...
\textup{(}Theorem~\textup{\ref{V1-thm:nms-all-arity-master-equation})}:
...
obstruction
\textup{(}Definition~\textup{\ref{V1-def:nms-arity-r-obstruction})}.
...
This is Theorem~\ref{V1-thm:nms-all-arity-master-equation}.
...
\textup{(}Theorem~\textup{\ref{V1-thm:nms-all-arity-separating-boundary})}:
...
(Theorem~\ref{V1-thm:nms-all-arity-separating-boundary}).
\end{proof}
...
\emph{Part (ii).}
Proposition~\ref{V1-prop:thqg-III-genus-1}.
...
\item Under perfectness and nondegeneracy hypotheses,
  ...
  (\S\ref{V1-subsec:thqg-III-shifted-symplectic}).
\item The complementarity potential $S_\cA$ generates the
  ...
  (\S\ref{V1-subsec:thqg-III-complementarity-potential}).
\item At genus $1$, the construction reduces to the
  BTZ bulk--boundary entanglement
  (\S\ref{V1-subsec:thqg-III-holographic-entanglement}).
\item All structures are verified for the standard landscape
  (\S\ref{V1-subsec:thqg-III-standard-landscape}).
\end{enumerate}
