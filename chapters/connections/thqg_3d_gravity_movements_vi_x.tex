...
specialization.
(iii): $F_g^{\mathrm{eff}} = \kappa_{\mathrm{eff}} \int_{\overline{\cM}_g}
\lambda_g = 0$.
...
= \sum_g F_g^{\mathrm{eff}} \hbar^{2g-2}$ is the effective scalar free
energy.  Each $F_g^{\mathrm{eff}}$ is proved in Movement~IV; the
