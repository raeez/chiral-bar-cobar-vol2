...
Every clause of Theorem~\ref{thm:synthesis} is proved below, except those clauses marked as conjectural bridges beyond the present theorem package.
...
\medskip
\noindent\textbf{(iii).} The spectral $R$-matrix
$R_{V_i,V_j}(z)$ of Definition~\ref{def:spectral-braiding},
restricted to evaluation modules, agrees with the quantum-group
$R$-matrix. The argument has three steps: reduction of the
