...
\item The ternary collision and Yang--Baxter equation
  (\S\ref{V1-subsec:thqg-V-ternary-collision}), deriving the CYBE from
  the Arnold relation on $\overline{\mathcal{M}}_{0,4}$.
\item The modular dg-shifted Yangian
  (\S\ref{V1-subsec:thqg-V-modular-yangian}), assembling the
...
\item The gravitational Yangian for the Virasoro algebra
  (\S\ref{V1-subsec:thqg-V-virasoro-yangian}), computing the explicit
...
\item Line-operator categories and MC3
  (\S\ref{V1-subsec:thqg-V-line-operators-mc3}), connecting the
...
arity~$2$ (Corollary~\ref{V1-cor:heisenberg-postnikov-termination}),
...
structure (Lemma~\ref{V1-lem:arity-cutoff}).
