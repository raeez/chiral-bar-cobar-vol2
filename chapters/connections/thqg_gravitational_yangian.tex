...
% AP19 note: r_H(z) derived from Casimir structure on A^!, not collision residue.
...
%
% AP1: kappa(Vir_c) = c/2, from C2 census; c=13 -> 13/2 verified.
...
= c/2 + (26-c)/2 = 13$
for all~$c$.
% AP1: kappa(Vir_c) = c/2 from landscape_census.tex; c=0 -> 0, c=13 -> 13/2.
