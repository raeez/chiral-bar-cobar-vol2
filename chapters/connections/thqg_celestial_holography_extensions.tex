...
\begin{remark}[Non-Koszul deformation]
\label{rem:non-koszul-spectral}
For non-Koszul algebras, the spectral sequence does \emph{not} degenerate at $E_1$.
...
\end{itemize}
The shadow depth classification (G/L/C/M) is therefore equivalent to the complexity
