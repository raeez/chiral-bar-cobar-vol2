...
Decomposing it by arity and show that each arity produces a soft theorem.
...
identically, providing the AP126 sanity check.
\end{definition}
...
\]
At $k_{\mathrm{BF}} = 0$ the leading kernel vanishes, providing the AP126 check.
