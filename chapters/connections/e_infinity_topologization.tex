...
at depth $N \le 3$ (Virasoro at $N = 2$ and $\cW_3$ at $N = 3$) the
ladder theorem is \emph{unconditional}. At depth $N \ge 4$ the ladder
theorem is \emph{conditional on axiom~\ref{tower:antighost-commutativity}
holding at all spins up to $N$}. The $\cW_\infty$-specialisation
