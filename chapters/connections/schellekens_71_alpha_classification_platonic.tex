...
values); and the $H^3$-cocycle restriction admits a trivialization in
the finite-orbifold BV model. The Type~C entries differ in the lattice
$\Lambda^\sigma$ and the twisted-vacuum conformal weight
$h_{\mathrm{tw}}$. The listed entries are precisely the
level-matched cyclic orbifolds; HT descent adds the
...
$8, 16, 24, 32, 40, \ldots$) lies outside the present theorem.
