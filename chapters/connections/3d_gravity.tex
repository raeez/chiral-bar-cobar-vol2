...
\begin{theorem}[$\Ethree$-topological for quantized freely generated PVAs; \ClaimStatusProvedHere]\label{thm:E3-topological-free-PVA}
...
is Theorem~\ref{thm:general-half-space-bv}: the BV fields, reflected
logarithmic propagator, renormalized graph weights, and QME
counterterms are constructed from the PVA Hamiltonian bidifferential.
The boundary identification supplies the boundary vertex algebra
\(\cA\). Applying Construction~\ref{constr:topologization} to this
quantized bulk gives the $\Ethree$-topological structure.
\end{proof}
