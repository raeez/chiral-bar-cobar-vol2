...
Under $\hypModularCardy$ — the modular-invariant unitary-CFT package
...
$F_g^{\mathrm{scal}}=\kappa\lambda_g^{\mathrm{FP}}$. Under these hypotheses, the
...
Under $\hypStokes$: the Borel transform of the completed ordered bar
trace has a singularity at $\zeta_{\ast} = 1/(2\pi)$, and the alien
derivative is defined by sectorial analytic continuation. The alien derivative
