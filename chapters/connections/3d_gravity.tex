...
curvature $\kappaChHodge(\mathrm{Vir}_0) = 0$, so the bar complex is
...
\kappa_{\mathrm{eff}}
\;=\;
\kappaChHodge(\mathrm{Vir}_c) + \kappa_{\mathrm{ghost}}
\;=\;
\frac{c}{2} - 13
\;=\;
\frac{c - 26}{2}.
...
\partial J_{h_j}$.}
and $(x_0)_i := \kappaChHodge(x_0, h_i)$ are the components of~$x_0$
...
$F_g=\kappaChHodge(\mathrm{Vir}_c)\lambda_g^{\mathrm{FP}}$ is convergent;
