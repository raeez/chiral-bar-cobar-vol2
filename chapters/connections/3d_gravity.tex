...
\item \textbf{Clutching maps.}
  ...
  \]
  is defined by sewing vertex bar complexes at edges via the
...
The genus-$0$ part~(i) and the modular
associativity~(iii) are proved.  The clutching
maps~(ii) are explicit at genus~$1$
(Construction~\textup{\ref{constr:genus1-ainf-chiral-operations}})
and conjectural at genus $\ge 2$.  The curvature~(iv)
is proved (it is the content of the shadow obstruction
tower).  For affine $V_k(\fg)$ at non-critical level,
...
\item \emph{BRST identity.}
 ...
 \textup{(}Volume~I,
 Construction~\textup{\ref*{constr:sugawara-antighost}}\textup{)}.
...
f_{ab}{}^c\,\bar c_c\, c^b$
\textup{(}\eqref{eq:brst-antighost} of Volume~I\textup{)}.
The ghost bilinear $f_{ab}{}^c\,\bar c_c\, c^b$ is
$Q_{\mathrm{CS}}$-exact in the bulk by the same mechanism
as in Construction~\ref*{constr:sugawara-antighost}
