...
\item \textbf{Modular associativity (open).}
  ...
  satisfies $D^2=0$
  (Theorem~\textup{\ref{thm:modular-bar}}), but that
  theorem concerns the abstract modular bar datum rather
  than the concrete clutching maps $\xi_\Gamma$ defined
  here. The concrete operadic associativity of
  $\mathcal{O}^{\Ainf\text{-ch}}$ remains open.
...
(Construction~\textup{\ref{constr:genus1-ainf-chiral-operations}}).
The concrete operadic associativity of the
clutching maps, as well as equivariance and unitality,
remain open.
