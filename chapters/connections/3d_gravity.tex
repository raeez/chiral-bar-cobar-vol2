...
%: kappa(Vir) from CLAUDE.md C2; c=0 -> 0, c=13 -> 13/2 verified
...
\item\label{item:scope-orbifold}
  ...
  VOA \textup{(}FM66, rem:monster-orbifold-route\textup{)};
...
The complementarity constant $K = \kappa + \kappa' = 13$ controls
more than the quantum corrections to the BTZ entropy. It determines
the transition between the two Koszul-dual phases of black hole
evaporation: the Hawking phase governed by the boundary curvature
...
$\kappa' = (26-c)/2$; the complementarity constant
$K = \kappa + \kappa' = 13$ is nonzero
.
...
saddles is controlled by $K = \kappa + \kappa' = 13$:
