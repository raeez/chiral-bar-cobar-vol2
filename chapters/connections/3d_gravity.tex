...
$c_{1}(0)/2 = 5$ doubled to $10$ via Virasoro--Koszul duality).
\end{description}
...
integral'' (\#12 of the voice table in CLAUDE.md~\S 8) is precisely
the (C5) $=$ (C6) collapse the four-part datum prohibits.
\end{remark}
