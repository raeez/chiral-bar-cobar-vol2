...
This section derives the holographic dictionary of
...
(Volume~I, Conjecture~\ref{conj:master-bv-brst})
is resolved in the coderived category $D^{\mathrm{co}}$ for all
four shadow classes
(Volume~I, Theorem~\ref{thm:bv-bar-coderived}).
...
(Volume~I, Remark~\ref{rem:bv-bar-class-c-proof}).
...
\lambda_g^{\mathrm{FP}}$, and the perturbative finiteness of
...
$r(z) = (c/2)/z^3 + 2T/z$ (the $E_1$ primitive) --- is strictly
...
language of
Volume~I, Principle~\textup{\ref*{princ:e1-primacy}}:
...
developed in Part~III (Section~\ref{ch:ordered-associative-chiral-kd},
...
$F_g = \kappa_{\mathrm{eff}} \cdot \lambda_g^{\mathrm{FP}}$ is
an invariant of the symmetric bar $\barBch(\mathrm{Vir}_c)$,
...
Assuming Conjecture~\ref{thm:gravity-cardy}, substitute
...
duality architecture of Part~III provides a finer invariant:
