...
algebra, and the Hopf/Steinberg endpoint when one asks for a
...
\begin{theorem}[SC convolution presentation of the conditional triangle; \ClaimStatusProvedHere]
