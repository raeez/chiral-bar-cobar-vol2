...
\begin{theorem}[Universal Holography]\label{thm:universal-holography}
\ClaimStatusProvedHere
...
The following theorem reconstructs $\Theta_\cA$ from finite-order obstruction data; it is the computational shadow of Theorem~\ref{thm:universal-holography} specialized to the modular Koszul locus.
\end{remark}
...
\begin{theorem}[Universal holography; \ClaimStatusProvedHere]%
\label{thm:universal-holography}%
...
\begin{proof}
Apply Theorem~\ref{thm:universal-holography}\ref{item:uh-bulk} to
