...
(Theorem~\ref{V1-thm:nms-all-degree-master-equation}),
...
\begin{proof}[Proof of Theorem~\textup{\ref{V1-thm:virasoro-rmax-infinity}}]
...
values differ; see
Theorem~\textup{\ref{V1-thm:thqg-virasoro-tower-explicit}}
and~\S\textup{\ref{V1-subsec:thqg-virasoro-tower}}.
\end{proposition}
...
$r \geq 6$; see
Theorem~\ref{V1-thm:thqg-virasoro-tower-explicit}.
\end{proof}
...
$j,k \geq 4$; see
\S\ref{V1-subsec:thqg-virasoro-tower} for exact values.
...
(Section~\ref{V1-sec:thqg-gravitational-complexity}) gives
...
\[
  K(\cA) \;=\; \mathrm{str}\bigl(\mathrm{centre}(\mathrm{Trinity}(\cA))\bigr)
