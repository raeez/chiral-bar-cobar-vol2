...
= \kappa\,\eta \otimes \Lambda$ with $\kappaChHodge(\mathcal{H}_k) = k$.
\end{theorem}
...
$\kappaChHodge(\cA_E) = 24$. The discrepancy is an instance :
...
bosons at level~$1$, so $\kappa = 24 \cdot \kappaChHodge(\cH_1) = 24$
...
(b) $\cA^!$ & Koszul dual: $24$ bosons at level $-\delta^{ab}$,
 $\kappaChHodge(\cA^!) = -24$; complementarity sum
 $\kappa + \kappa' = 0$ \\
