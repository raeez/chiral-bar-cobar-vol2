...
\begin{remark}[Finite-order shadow reconstruction]
The following theorem reconstructs $\Theta_\cA$ from finite-order
obstruction data; it is the computational shadow of
Theorem~\ref{thm:holographic-recon-shadow} specialised to the modular
Koszul locus.
\end{remark}
...
\begin{theorem}[Universal holography on the admissible boundary-linear/DS locus; \ClaimStatusConditional]%
...
construction: each admissible datum carries, by virtue of its conformal
vector together with its boundary-linear, affine, or DS origin, a canonical
relative $3$d holomorphic-topological theory. The four-part statement
...
$\mathbf H_{\Delta_5}$-modules: the MTC $\mathcal C$ is the category
of admissible boundary conditions for the Hopf-categorified sector, not
the category of admissible boundary chiral algebras itself. The
admissible-locus reconstruction of
Theorem~\ref{thm:universal-holography-master} realises
$\tau_{\mathcal C}(M^3)$ as the gravitational path integral
