...
\end{enumerate}
Computational verification:
\texttt{compute/lib/cy\_twisted\_holography\_k3e\_engine.py}.
\end{proposition}
...
\texttt{compute/lib/cy\_twisted\_holography\_k3e\_engine.py},
functions
\texttt{holographic\_datum\_k3e()},
\texttt{shadow\_tower\_k3e()},
\texttt{koszul\_dual\_k3e()}.
\end{computation}
...
= (1, 2, 23, 44, 23, 2, 1),
\end{equation}
with CY Serre duality $\HH^n \cong \HH^{6-n}$ verified
\textup{(}computational:
\texttt{compute/lib/cy\_nc\_deformation\_k3e\_engine.py}\textup{)}.
\end{remark}
...
Computational verification of factorization homology:
\texttt{compute/lib/cy\_factorization\_homology\_k3e\_engine.py}.
\end{remark}
