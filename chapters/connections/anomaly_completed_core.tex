...
$\kappa_{\mathrm{eff}} = \kappa(\text{matter}) + \kappa(\text{ghost}) = 0$.
...
$H^2(\overline{\mathcal{A}_2}, \mathcal{O}^*)$; its unique
trivialiser is the Gritsenko--Nikulin Igusa cusp form $\Delta_5$,
with
\[
 \mathrm{wt}(\Delta_5)
