...
% Locks AP159 four-Yangian-types disambiguation (THE central concern of
% this chapter), AP161 Notion-B working default for the dg-shifted
% package, AP170 equivalence of two chiral Yangian definitions OPEN at
% chain level, AP-RMATRIX level-prefix discipline for spectral kernels,
% AP128 (Psi-1)/Psi cross-term for higher-spin coproducts, and the
% Wave-14 cross-references to thm:koszul-reflection,
% thm:universal-holography-master, chap:climax-platonic, and
% chap:universal-conductor. All labels new; no existing material modified.
% ======================================================================

\section{Adversarial discipline block (Wave-14 anchor)}
\label{sec:dg-shifted-bridge-wave14-anchor}

\subsection{Four Yangian types as the disambiguation gap}
\label{subsec:dg-shifted-bridge-ap159-yangian-types}
...
\begin{convention}[AP159: dg-shifted Yangian $Y^{\mathrm{dg}}_\hbar(\fg)$
is the bridge target; \ClaimStatusProvedHere]
\label{conv:dg-shifted-bridge-ap159-yangian-types}
The four Yangian types of Vol~I AP159, as visible in this chapter:
...
OPEN at chain level]
\label{rem:dg-shifted-bridge-ap170-two-definitions}
Vol~I AP170 records two chiral Yangian definitions: the weaker
...
\subsection{AP161 working default: the dg-shifted Yangian is
Notion-B}
\label{subsec:dg-shifted-bridge-ap161-five-notions}

\begin{convention}[AP161: this chapter uses Notion~B;
\ClaimStatusProvedElsewhere]
\label{conv:dg-shifted-bridge-ap161-notion-b}
...
\subsection{AP128 universality on dg-shifted Yangian coproducts}
\label{subsec:dg-shifted-bridge-ap128}

\begin{remark}[$(\Psi-1)/\Psi$ on the dg-shifted Yangian
spectral coproduct; \ClaimStatusProvedElsewhere]
\label{rem:dg-shifted-bridge-ap128}
...
\subsection{Wave-14 anchor: bridge feeds the universal holography
master theorem}
\label{subsec:dg-shifted-bridge-wave14-anchor}

\begin{remark}[Bridge specialises the unified Vol~I Koszul reflection;
\ClaimStatusProvedElsewhere]
\label{rem:dg-shifted-bridge-wave14-koszul-reflection}
...
\label{rem:dg-shifted-bridge-wave14-uhm-bridge}
...
\label{rem:dg-shifted-bridge-wave14-conductor-bridge}
