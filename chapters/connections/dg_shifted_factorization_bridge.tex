...
The philosophy is deliberately first-principles.
We do not attempt to impose a strict $R$-matrix directly on the
$A_\infty$ object.  We pass first to ordered configuration spaces,
construct a flat connection, read off regularized holonomy, and only
then formulate the spectral factorization problem.  This is the point
at which the dg, chiral, factorization, and geometric pictures begin to
line up.
...
which a fundamentally new obstruction can appear.
