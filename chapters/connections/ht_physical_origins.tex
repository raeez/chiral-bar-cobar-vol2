...
\begin{remark}[M-theory physical origins of the K3 chiral bialgebra]
\label{rem:htpo-1}
...
$\Delta_5$ requires a gauge redefinition of the
...
producing the $\Phi_{10}^{\mathrm{un}}/\eta^{24}$ associator twist.
\end{remark}
