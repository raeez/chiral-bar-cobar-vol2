...
\begin{remark}[Scope]
Open-string side proved (Theorems~\ref*{V1-thm:bar-semi-infinite-km}, \ref*{V1-thm:bar-semi-infinite-w}).  MC4 is proved in Volume~I and the analytic lane of MC5 is proved at all genera (the full genuswise BV/BRST/bar identification remains conjectural); the closed-string identification is now accessible via the all-genera bar-cobar framework, subject to that conjectural step.
\end{remark}
...
\begin{remark}[Scope]
Individual levels are established \cite{BD04,CG17,CWY18}; the analytic HS-sewing lane of MC5 is proved at all genera in Volume~I, while the full genuswise BV/BRST/bar identification remains conjectural, so the bar-cobar side of the iterated identification is accessible subject to that conjectural step.
\end{remark}
...
\begin{remark}[Scope]
The 2D side is proved (Theorem~\ref{thm:agt-2d-bar}); the 4D--2D bridge is proved in specific cases \cite{SV13,MO19}.  MC4 is proved in Volume~I and the analytic lane of MC5 is proved at all genera (Chapter~\ref*{V1-chap:concordance}), while the full genuswise BV/BRST/bar identification remains conjectural; the remaining obstruction is the 4D--2D bridge for general gauge groups.
\end{remark}
