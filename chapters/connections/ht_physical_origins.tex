...
the present chapter establishes the HT side, the Volume~III CY
Landscape part establishes the CY side, and the two sides meet through $\Phi$ and
...
\subsection{Honest frontier: HT origins not yet established}
...
chiral-algebra families that are given in the shadow-obstruction
...
or presently absent. They are flagged here as honest frontier,
...
involution (not as a sublane of small $\cN=4$) is not yet established
...
programme but is not established in this chapter; the boundary
...
not yet established. The Paquette--Williams boundary framework
...
admissible levels are not treated separately; they sit under
...
chapter); they are not re-established in
...
affine Kac--Moody, not raw CoHA outputs. This is recorded as
...
The foundational analysis established the $1$-loop origin of $\Delta_5$ as BV quantum
