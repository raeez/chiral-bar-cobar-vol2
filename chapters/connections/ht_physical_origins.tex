...
\label{conj:nc-torus-koszul-morita}
...
Conjectures~\ref{conj:nc-cs}, \ref{conj:nc-torus-koszul-morita}, and
...
\item \emph{Koszul--Morita duality} (Conjecture~\ref{conj:nc-torus-koszul-morita}).
...
\begin{theorem}[Observables and the bar comparison; \ClaimStatusConditional]
...
Under the genus-zero BV/bar comparison or the conditional
diagonal-residue BV package:
...
\label{rem:htpo-1}
The K3 synthesis twisted $11$D SUGRA on $K3\times T^2$ with $24$ M$5$-branes
...
The K3 synthesis identifies the Tannakian fibre functor on
...
Chapter~\ref{V3-ch:cy-to-chiral}; without it, ``CoHA $=$ chiral algebra''
...
The $1$-loop BV quantum master equation produces $\Delta_5$ as the
automorphic anomaly datum. The two-loop computation lifts this to
$\hbar^2$ with obstruction-free verification. See Vol~I
Proposition~\ref{V1-prop:bvbrst-2loop-obstruction} in
...
producing the $\Phi_{10}/\eta^{24}$ associator twist.
\end{remark}
