...
Cross-ref Vol~III Remark~\ref{rem:cydkappa-gerbe}.  Primary:
...
Remark~\ref{rem:htpo-coha-not-chiral}, the deeper cache pattern
...
Proposition~\ref{prop:bvbrst-2loop-obstruction} in
