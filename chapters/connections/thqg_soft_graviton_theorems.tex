...
(Definition~\ref{def:shadow-postnikov-tower}), form the celestial
...
\item The arity-$3$ Ward identity gives the subleading factor
  ...
  non-triviality (\S\ref{subsec:thqg-VI-subleading-soft}).
\item The arity-$4$ Ward identity gives the sub-subleading factor
  ...
  curves (\S\ref{subsec:thqg-VI-sub-subleading-soft}).
