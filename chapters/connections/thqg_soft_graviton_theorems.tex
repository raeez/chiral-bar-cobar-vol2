...
(Theorem~\ref*{V1-thm:mc2-bar-intrinsic}).  The horizontal
sections of $\nabla^{\mathrm{hol}}_{g,n}$ define the genus-$g$,
$n$-point derived coinvariant transport package.  The Ward
identities of this connection, decomposed by the arity filtration
of the shadow obstruction tower
(Definition~\ref{V1-def:shadow-postnikov-tower}), form the celestial
soft hierarchy of the title.

Four results:
\begin{enumerate}[label=\textup{(\arabic*)}]
\item The arity-$2$ Ward identity gives the leading celestial soft
  factor (Weinberg's soft theorem, supertranslation/BMS reading;
  \S\ref{V1-subsec:thqg-VI-leading-soft}).
\item The arity-$3$ Ward identity gives the subleading factor
  (Cachazo--Strominger), with the cubic gauge triviality of
  Theorem~\ref{thm:cubic-gauge-triviality} controlling
  non-triviality (\S\ref{V1-subsec:thqg-VI-subleading-soft}).
\item The arity-$4$ Ward identity gives the sub-subleading factor
  with coefficient
  $Q^{\mathrm{contact}}_{\mathrm{Vir}} = 10/[c(5c+22)]$;
  the clutching law controls factorization across degenerate
  curves (\S\ref{V1-subsec:thqg-VI-sub-subleading-soft}).
\item The infinite tower for algebras with
  $r_{\max}(\cA) = \infty$ (Virasoro, $\mathcal{W}_N$):
  $o_5(\mathrm{Vir}_c) \neq 0$
  (\S\ref{V1-subsec:thqg-VI-higher-soft},
  \S\ref{V1-subsec:thqg-VI-celestial}).
\end{enumerate}
...
the sum~\eqref{V1-eq:thqg-VI-arity-decomposition} terminates at
$r = r_{\max}$.

The \emph{shadow depth classes} are defined in
\S\ref{V1-sec:thqg-gravitational-complexity}
...
$\Sh_{g,n}$ (Definition~\ref{V1-def:thqg-VI-shadow-representation}).
...
arity decomposition~\eqref{V1-eq:thqg-VI-nabla-arity}.  Write
...
(Proposition~\ref{V1-prop:master-equation-from-mc}) is obtained by
...
the endomorphism equation~\eqref{V1-eq:thqg-VI-flat-arity-r-general}
...
\eqref{V1-eq:thqg-VI-flat-arity-r-general} closes at $r = r_{\max}$:
...
(Result~\textbf{(G2)}, \S\ref{V1-sec:thqg-gravitational-complexity}).
\end{remark}
...
(Theorem~\ref{V1-thm:w-virasoro-quintic-forced}), so the tower
...
the soft expansion.  See Table~\ref{V1-tab:thqg-VI-soft-dictionary}.
\end{remark}
...
(Definition~\ref{V1-def:thqg-VI-shadow-representation}): at arity~$2$,
...
(equation~\eqref{V1-eq:thqg-VI-flat-arity-2}) states that
$\Sh_{0,n+1}(\kappa) \cdot \Phi = 0$.
By Proposition~\ref{V1-prop:thqg-VI-kappa-action}, this reads
\[
\sum_{i=1}^{n}
...
(Definition~\ref{V1-def:thqg-VI-shadow-representation}) sums over
...
(equation~\eqref{V1-eq:thqg-VI-flat-arity-3}) states
\[
...
(Corollary~\ref{V1-cor:thqg-VI-bms-supertranslation}); the
...
(Volume~I, equation~\eqref*{V1-eq:clutching-factorization-frontier}), projecting
...
arity-$4$ flatness equation~\eqref{V1-eq:thqg-VI-flat-arity-4}.  In the
...
(Theorem~\ref{V1-thm:thqg-VI-flatness-by-arity}(c)) states:
\[
...
Theorem~\ref{V1-thm:thqg-VI-flatness-by-arity}(d).  The arity-$r$
...
of Theorem~\ref{V1-thm:thqg-VI-sub-subleading-soft} shows that
...
\end{equation}
By the recursion of Corollary~\ref{V1-cor:thqg-VI-soft-recursion}, the
...
\begin{proof}
By Proposition~\ref{V1-prop:thqg-VI-polynomial-growth}(iv),
...
Theorem~\ref{V1-thm:thqg-VI-ward-determines-correlators}.
\end{definition}
...
\item $\mathfrak{S}(\cA)$ is generated by the arity-$2$ and
  ...
  Theorem~\ref{V1-thm:thqg-VI-flatness-by-arity}.
\item The arity-$2$ sector generates the binary celestial soft
  subalgebra controlled by
  Corollary~\ref{V1-cor:thqg-VI-bms-supertranslation}.  In the
...
\item The arity-$3$ sector, combined with arity-$2$, generates the
  ...
  Corollary~\ref{V1-cor:thqg-VI-superrotation}.  In the
...
Corollary~\ref{V1-cor:thqg-VI-soft-recursion}: each higher-arity
...
Remark~\ref{V1-rem:thqg-VI-cubic-source}), and $\mathfrak{C}$ is
the arity-$3$ shadow, the full tower is generated by arities $2$
and~$3$.

Parts~(ii)--(iii): Proved in
Corollary~\ref{V1-cor:thqg-VI-bms-supertranslation} and
Corollary~\ref{V1-cor:thqg-VI-superrotation}.
...
Corollary~\ref{V1-cor:thqg-VI-bms-supertranslation}.
...
Remark~\ref{V1-rem:thqg-VI-w-infinity}.
\end{proof}
...
(Proposition~\ref{V1-prop:thqg-VI-kappa-action}).  The resulting
...
\item \textbf{(G1)} Perturbative finiteness: The celestial soft factors
  ...
  (arity cutoff, Lemma~\ref{V1-lem:arity-cutoff}).
...
\begin{remark}[Celestial OPE coefficients from shadow arity]
\label{rem:celestial-ope-shadow-arity}
\index{celestial OPE!from shadow arity|textbf}
\index{soft graviton theorem!shadow-arity dictionary}
\index{shadow depth!celestial OPE truncation}
The soft graviton theorem hierarchy has an exact
shadow-arity dictionary: soft order~$p$ corresponds to
shadow arity $r = p + 2$.  The leading independent
coefficients are:
\begin{enumerate}[label=\textup{(\roman*)}]
\item $C_1 = \kappa(\cA)$ (Weinberg, 1965):
...
\item $C_3 = 4\,Q^{\mathrm{contact}}(\cA)$:
  ...
  $C_3 = 40/[c(5c{+}22)]$.
\end{enumerate}
Shadow depth controls the truncation of the celestial OPE:
...
infinitely many (the full shadow obstruction tower).
...
\item \emph{Infrared divergences.}  The soft expansion
  ...
  (Corollary~\ref{V1-cor:thqg-VI-soft-convergence}), but the
