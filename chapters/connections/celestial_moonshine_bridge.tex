...
% standalone extraction and cross-volume migration (V2-AP39, FM36).
...
\]
Following AP113 (zero tolerance for bare $\kappa$) we subscript every
occurrence: $\kapch$ for chiral bar, $\kapcat$ for categorified Euler
characteristic of K3 (which equals $\chi(\cO_{K3}) = 2$; AP-CY34), and
...
(AP152), it refers to labelled configurations on the celestial sphere,
...
We now assemble Strominger's celestial $\wtc$ and the Gaberdiel--Hohenegger--Volpato
...
identity is traced to its arrow. Compare AP-CY57
(construction not narration).
\end{remark>
...
labelled by $\MtwFour$-conjugacy classes. We now make the action
explicit.
...
Vol~I AP70/AP71 flagged shadow-invariant / $L$-function connections as
...
at depth 2 (Vol~I AP39 for the $\mathcal{N}{=}4$ superconformal algebra
...
\begin{remark}[Closes Vol~I AP70/AP71 in the K3 lane]
\label{rem:cmb-closes-ap70-ap71}
Vol~I AP70/AP71 note that the shadow $L$-function of Vir and of a
...
\label{rem:cmb-ap-cy60}
AP-CY60 notes that the six Vol~III routes to $G(K3 \times E)$ are
SIX DIFFERENT constructions; convergence is the CONTENT of CY-C,
conjectural. The present celestial correspondence is a SEVENTH route,
...
(a) The construction-not-narration demand of AP-CY57 for the moonshine
connection.
(b) The aspirational AP70/AP71 link from Vol~I in the K3 lane:
shadow-tower coefficients equal Rademacher expansion coefficients of
