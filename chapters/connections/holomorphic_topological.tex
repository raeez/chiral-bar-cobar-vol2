...
where $d_g$ (the genus-$g$ component of $\Dg{\bullet}$, Convention~\ref*{V1-conv:higher-genus-differentials}) is the genus-$g$ contribution from the modular operad decomposition.
...
carries a differential whose genus-$g$ component $d_g$ (in the sense of Convention~\ref*{V1-conv:higher-genus-differentials}) is assembled from
