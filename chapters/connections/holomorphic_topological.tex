...
Every chiral algebra in Part~II has a secret four-dimensional
life: it arises as the boundary theory of a holomorphic-topological
field theory in the sense of Costello--Li.  The bar-cobar adjunction,
from this perspective, is the mathematical shadow of boundary-bulk
...
\begin{remark}[Scope]
Chirality is proved for $\mathcal{N}=4$ SYM (Theorem~\ref{thm:cl-n4-chirality}); the general case remains conjectural.  See \cite{CDG20,GKW24,Zeng23} for related work.  Contributing to Conjecture~MC5 (Vol~I).
\end{remark}
...
\begin{remark}[Scope]
Conditions~(i)--(iii) are established for $\mathcal{N}=4$; the general case is conjectural.  Coefficient identities resolved (MC4 closed, Vol~I); the bulk/bar identification belongs to MC5 (Conjecture~MC5, Vol~I).
\end{remark}
...
(Contributing to Conjecture~MC5, Vol~I.)
\end{remark}
...
\begin{remark}[Scope]
Open-string side proved (Theorems~\ref{thm:bar-semi-infinite-km}, \ref{thm:bar-semi-infinite-w}).  MC4 closed; closed-string identification belongs to MC5 (Conjecture~MC5, Vol~I).
\end{remark}
...
\begin{remark}[Scope]
Individual levels are established \cite{BD04,CG17,CWY18}; the iterated bar-cobar claim is conjectural (Conjecture~MC5, Vol~I).
\end{remark}
...
\begin{remark}[Scope]
The 2D side is proved (Theorem~\ref{thm:agt-2d-bar}); the 4D--2D bridge is proved in specific cases \cite{SV13,MO19}.  MC4 resolved (Vol~I); the bulk identification belongs to MC5 (Chapter~\ref{chap:concordance}, Conjecture~MC5, Vol~I).
\end{remark}
