...
\end{equation}
Shadow termination arity equals $A_\infty$-depth equals
$L_\infty$-formality level.
\end{theorem}

\begin{proof}
By induction on arity. At genus~$0$, stable graphs are trees.
...
\textup{(}Proposition~\textup{\ref*{V1-prop:shadow-formality-low-arity}}\textup{)}.
...
$\mathfrak{C}(\cA) \neq 0$
\textup{(}Vol~I, Proposition~\textup{\ref*{V1-prop:shadow-formality-low-arity}(ii)}\textup{)}:
