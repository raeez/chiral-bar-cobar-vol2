...
Proposition~\ref{V1-prop:thqg-two-sources} and
Lemma~\ref{V1-lem:thqg-cubic-source}.
...
$\mathfrak{Q} \neq 0$.
Lemma~\ref{V1-lem:thqg-cubic-source} gives:
...
(Theorem~\ref{V1-thm:thqg-virasoro-quintic}).
...
follows from Lemma~\ref{V1-lem:thqg-cubic-source} once
...
$\lambda$-bracket) receives an degree-$r$ contribution as a
...
(Proposition~\ref{V1-prop:thqg-virasoro-structure}(i)) gives
...
(Theorem~\ref{V1-thm:thqg-virasoro-infinite}) gives
...
Theorem~\ref{V1-thm:thqg-four-class} uses properties specific
...
Problem~\ref{V1-open:thqg-gap}\textup{)} translates to: does
...
This answers Open Problem~\ref{V1-open:thqg-categorical}
