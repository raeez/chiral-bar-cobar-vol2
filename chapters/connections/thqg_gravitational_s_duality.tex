...
\label{sec:grav-sdual-wave13-DNA}

\begin{remark}[Gravitational $S$-duality on $K3\times T^2$ M-theory]
\label{rem:grav-sdual-DNA-1}
The gravitational $S$-duality structures of this chapter are realised
concretely at the Wave~13 K3 base point through the four duality frames
unified by $\Phi_{10}$ (Vol.~II, \S\ref{sec:line-operators-wave13-DNA}).
...
precise statement on $\mathbf H_{\Delta_5}$: the Wave~13 chiral bialgebra
...
the $M_{24}$-action. This is the gravitational face of the Wave~13
