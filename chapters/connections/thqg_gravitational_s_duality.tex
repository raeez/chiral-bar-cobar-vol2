...
The map $\sigma$ of
Definition~\textup{\ref{V1-def:thqg-IV-verdier-convolution}} satisfies:
\begin{enumerate}[label=\textup{(\alph*)}]
...
Lemma~\ref{V1-lem:thqg-IV-verdier-graph-composition}
...
(Lemma~\ref{V1-lem:thqg-IV-verdier-graph-composition}(c)),
...
Proposition~\ref{V1-prop:thqg-IV-verdier-dg-lie}):
\[
l_1(\sigma(\alpha))
...
\begin{proof}
Apply Theorem~\ref{V1-thm:thqg-IV-theta-duality} twice:
...
where the first equality uses Proposition~\ref{V1-prop:thqg-IV-verdier-dg-lie}(b)
and the second uses Theorem~\ref{V1-thm:thqg-IV-theta-duality}.
\end{proof}
...
By Theorem~\ref{V1-thm:thqg-IV-shadow-duality} with $r = 3$:
...
Proposition~\ref{V1-prop:thqg-IV-verdier-dg-lie}, hence the vanishing
is preserved.
\end{proof}
...
case of Theorem~\ref{V1-thm:thqg-IV-shadow-duality},
...
(Definition~\ref{V1-def:thqg-gravitational-obstruction}).
Since $\sigma$ preserves the degree filtration and intertwines
$d_2 = d + [\Theta^{\leq 2}, -]$ by Proposition~\ref{V1-prop:thqg-IV-fundamental-diagram}:
$\sigma(o_{r+1}(\cA)) = o_{r+1}(\cA^!)$.
\end{proof}
...
By Theorem~\ref{V1-thm:thqg-IV-theta-duality}, $\sigma(\Theta_\cA) = \Theta_{\cA^!}$.
...
$\sigma$ by Theorem~\ref{V1-thm:thqg-IV-kz-duality}.
\end{proof}
...
(Proposition~\ref{V1-prop:thqg-IV-verdier-dg-lie}), $\sigma^*$ preserves
...
(Proposition~\ref{V1-prop:thqg-IV-bc-bg-K} at $\lambda = 2$).
...
(a)~$26 - 13 = 13$.
(b)~$\kappa = 13/2 \neq 0$.
(c)~By Theorem~\ref{V1-thm:thqg-IV-shadow-duality}: if $\cA = \cA^!$,
...
Theorem~\ref{V1-thm:thqg-IV-four-facets} degenerate simultaneously:
...
Theorem~\ref{V1-thm:thqg-IV-km-K}. The level-rank duality
...
(d)~Theorem~\ref{V1-thm:thqg-IV-theta-duality}.
(e)~$\sigma(\nabla^{\mathrm{hol}}_{g,n})
...
Theorem~\ref{V1-thm:thqg-IV-theta-duality}.
\end{proof}
...
differential of Corollary~\ref{V1-cor:thqg-IV-twisted-tangent}.
...
$\sigma(\Theta_\cA) = \Theta_{\cA^!}$ & Thm~\ref{V1-thm:thqg-IV-theta-duality} \\
\hline
Dual graviton & Koszul dual $\cA^!$ & Thm~\ref*{V1-thm:verdier-bar-cobar} \\
\hline
$S$-duality invariant coupling &
$K(\cA)$ & Def~\ref{V1-def:thqg-IV-complementarity-constant} \\
\hline
Self-dual point & $\cA \simeq \cA^!$ &
Prop~\ref{V1-prop:thqg-IV-self-dual-classification} \\
\hline
Electric-magnetic duality &
Verdier on $\Ran(X)$ & Thm~\ref*{V1-thm:verdier-bar-cobar} \\
\hline
Feigin--Frenkel duality &
$\kappa \leftrightarrow \kappa'$ & Thm~\ref{V1-thm:thqg-IV-four-facets}(II) \\
\hline
Level-rank duality & $K = 0$ for KM &
Thm~\ref{V1-thm:thqg-IV-four-facets}(III) \\
\hline
Shifted-symplectic &
$(-1)$-shifted Lagrangian & Thm~\ref{V1-thm:thqg-IV-four-facets}(IV) \\
\hline
Critical level & $\kappa = 0,\ \Theta^{\min}=0$ &
Thm~\ref{V1-thm:thqg-IV-critical-degeneration} \\
\hline
No-ghost theorem & BRST = $\Theta$-twisted &
Rem~\ref{V1-rem:thqg-IV-no-ghost} \\
\hline
Conformal anomaly ($c = 26$) &
$K(\mathrm{Vir}) = 13$ & Thm~\ref{V1-thm:thqg-IV-virasoro-K} \\
\hline
Gravitational complexity &
Shadow depth $r_{\max}$ & Cor~\ref{V1-cor:thqg-IV-shadow-depth} \\
\hline
Shadow/KZ duality on affine comparison surface &
$\sigma(\nabla^{\mathrm{sh}}_\cA)=\nabla^{\mathrm{sh}}_{\cA^!}$;
affinely this corresponds to Feigin--Frenkel on KZ &
Thm~\ref{V1-thm:thqg-IV-kz-duality} \\
\hline
BPZ duality &
$c \mapsto 26-c$ on BPZ equations &
Prop~\ref{V1-prop:thqg-IV-bpz-duality} \\
\hline
Monodromy reciprocation &
$\lambda_i \mapsto \lambda_i^{-1}$ &
Prop~\ref{V1-prop:thqg-IV-monodromy-duality} \\
\hline
Partition function functional eq. &
$Z_g \cdot Z_g' = e^{K\lambda_g^{\mathrm{FP}}}$ &
Prop~\ref{V1-prop:thqg-IV-partition-duality} \\
\hline
Holographic datum duality &
$H(T) \mapsto H(T^!)$ &
Prop~\ref{V1-prop:thqg-IV-holographic-datum} \\
\hline
\end{tabular}
\end{center}
...
Proposition~\ref{V1-prop:thqg-IV-clutching}) and to the sewing envelope
