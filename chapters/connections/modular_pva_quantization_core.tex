...
\begin{theorem}[KZ-locus genus-zero boundary quantization]\label{thm:kz-locus-tree}
...
Under the hypotheses of \cref{thm:kz-locus-tree}, if all obstruction classes vanish,
then there exists
\[
