...
\label{constr:vol2-shadow-archetype}
...
\end{tabular}
\end{center}
Shadow depth classifies the \emph{complexity} of the Lagrangian self-intersection within the standard families.  Classes~$\mathsf{G}$, $\mathsf{L}$, $\mathsf{C}$ are chirally Koszul; class~$\mathsf{M}$ (Virasoro, $\mathcal{W}_N$) is not, though it possesses well-defined Koszul duals carrying higher $A_\infty$ operations (Vol~I, Theorem~\ref{thm:koszul-equivalences-meta}).
\end{construction}
