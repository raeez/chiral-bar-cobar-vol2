...
\label{rem:was-DNA-1}
The Wave~13 stable $W$-algebra at the K3 base point is the Schur-sector
chiral algebra $\mathbf H_{\Delta_5}$ of class-$\mathcal S$ $A_1$ on
$\Sigma_{0,24}$: central charge $c_{2d} = -312$, Coulomb rank $21$,
flavour $\mathfrak{su}(2)^{24}$. The stable-$W$ Miura transformation
...
the Wave~13 fingerprint \cite{Borcherds1992,Gritsenko1999}. Cross-ref
