...
% AP19: This is the Laplace kernel r^L(z), not the collision residue r^{coll}(z).
...
% AP124: primary label thm:wn-class-M lives in w-algebras-w3.tex; this is the stable-landscape copy
