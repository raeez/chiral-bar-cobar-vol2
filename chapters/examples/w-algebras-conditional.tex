...
target. Cross-ref Vol.~III Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}.
\end{remark}
...
\item Enriques surface: $\chi_{\mathrm{top}} = 12$, $h^{2,0} = 0$,
 ...
 \(\mathbf{H}_{\Delta_5}\) is a source/orbifold-recognition target, not a
...
base points, not specialisations of a universal family. Cross-ref Vol.~III preface
...
\begin{remark}[Heterotic decoupling limit as a recognition target]
...
orbifold root-sector bookkeeping, and conjectural
$2.M_{12}$-moonshine module structure. Full construction in Vol.~III
\texttt{k3e\_bkm\_chapter.tex},
\S\ref{sec:bkm-enriques-W18}; the present section records the
$W$-algebra deformation-landscape view.
...
Theorem~\ref{V3-thm:k3-abelian-at-lie}). Conditional on the Enriques
...
$\mathbb{Z}/2$-gauging only after the source/orbifold-recognition target
