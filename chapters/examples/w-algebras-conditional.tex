...
\item In the $T$-sector, the conditional wheel-residue hypothesis of
...
in the bi-graded finite-pole model generated by $T$ and $W$.
...
\begin{table}[h]
\centering
\caption{Higher $A_\infty$ Operations: Conditional Nonzero Range}
\begin{tabular}{|c|c|c|}
\hline
Algebra & Nonzero $m_k$ & Dominant Loop Order \\
\hline
Virasoro & conditional all $k \geq 3$ (Prop.~\ref{prop:vir-truncation}) & Tree + 1-loop \\
$W_3$ & conditional all $k \geq 3$ (Thm.~\ref{thm:wn-class-M}) & Tree + up to 2-loop \\
$W_4$ & conditional all $k \geq 3$ (Thm.~\ref{thm:wn-class-M}) & Tree + up to 3-loop \\
\hline
\end{tabular}
\end{table}
...
see Vol.~III preface
Remark~\ref{rem:v3-preface-4-etingof-super-EK}) rather
...
Remark~\ref{rem:dcy-W17-landscape-partition}):
\begin{center}
\begin{tabular}{lccl}
\toprule
...
Theorem~\ref{thm:wac-W17-enriques-weight} as the orbifold
...
Theorem~\ref{V3-thm:k3-abelian-at-lie}). The $\mathbb{Z}/2$-gauged
