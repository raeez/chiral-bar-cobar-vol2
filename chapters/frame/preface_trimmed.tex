...
equation forces the unique weight
\[
5
\;=\;
\chi(\mathcal{O}_{K3})
...
$\Phi_{10}/\eta^{24}$, and the remaining obstruction space
\[
...
The topologisation ladder from the class-$\mathbf{M}$ critical level
reaches $W_\infty^{\mathrm{top}}$ at an endpoint. At the
