...
\item These operations satisfy the axioms of a Poisson vertex algebra
 ...
 Leibniz rule\textup);
\item If compatible topological nullhomotopies are supplied, the
...
Under Hypotheses H1--H4 and compatible topological nullhomotopies,
...
\item Under compatible topological nullhomotopies, the higher
...
Assume \textrm{(H1)--(H4)} and compatible topological nullhomotopies
for the ordered topological factors.
