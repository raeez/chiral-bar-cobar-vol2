...
Assume {\rm (H1)--(H4)}. Let $[a],[b],[c]\in H^\bullet(\A,Q)$ be cohomology classes with representatives $a,b,c$ satisfying $Qa=Qb=Qc=0$. Then the $(-1)$-shifted $\lambda$-bracket satisfies the Jacobi identity:
\begin{equation}
