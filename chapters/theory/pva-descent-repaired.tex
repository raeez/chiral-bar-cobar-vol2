...
the current framework: the product decomposition of Definition~\ref{def:log-SC-algebra},
$\widetilde\omega_k = \omega_k^{\mathrm{hol}}\wedge\omega_k^{\mathrm{top}}$,
and the contractibility of the ordered topological configuration space
$\Conf_k^{<}(\R)$.
