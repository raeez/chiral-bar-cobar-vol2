...
\section{Cohomological descent to a shifted Poisson vertex algebra: repaired proof}
\label{sec:PVA_descent}
\label{sec:Ainfty-to-PVA}

This section gives a repaired proof of the descent from the binary operation $m_2$ to a
...
Proposition~\ref{prop:m3_vanish} crucially uses $d'=1$ (one topological direction).
...
genuine chain-level $m_3$ (Example~\ref{ex:m3_LG})---but they become $Q$-exact
