...
the residue along $D_{\{1,2\}}$ is the restriction of the Poisson
bivector to the $(2,0)$-projection of the cotangent fibre.
...
that defines the $\lambda$-bracket.  Under a full loop around
$D_{1,2}$, the logarithmic form $d\log(z_1 - z_2)$ acquires
a sign from $z_1 - z_2 \mapsto z_2 - z_1$, so the residue
picks up a factor of $-1$.  Algebraically:
