...
\begin{proposition}[$A_\infty$ degree-$2$ compatibility; \ClaimStatusProvedHere]
\label{prop:m1_m2}
...
\eqref{eq:ainfty-relation-raw}. No other term occurs at degree $2$.
\end{proof}
...
The previous subsections close the PVA layer itself. The proof of that all higher
...
the $A_\infty$ differential (the Stasheff identity at degree~$k$
