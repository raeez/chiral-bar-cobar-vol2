...
(Conjecture~\ref{thm:beta-N-closed-form-proved-all-N}).} For every
integer $N \ge 2$,
\[
...
($15$ and $16$ versus $13$); $\beta_N$ is rational, not integer, at
$N = 5$ under the harmonic law. The conditional convergence radius
is
\[
 \rho_*^{\cW_N}(c)
 \;=\;
...
harmonic closed form gives the conditional exact convergence radius.
