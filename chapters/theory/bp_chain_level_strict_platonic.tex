...
\item corollary strengthening Vol~I Theorem~\ref{V1-thm:topologization-tower} class~M entry for BP from weight-completed to ORIGINAL complex.
\end{enumerate}
\end{remark}
...
Vol~I Theorem~\ref{V1-thm:topologization-tower} class~M entry for BP. The
...
\ClaimStatusProvedHere
The class-M entry of Vol~I Theorem~\ref{V1-thm:topologization-tower} for BP is
...
The HZ-IV independent-verification protocol is honored by three
pairwise-disjoint decorators attached to the
...
\end{verbatim}
This is the HZ-IV independent-verification protocol in executable form.
\end{remark}
