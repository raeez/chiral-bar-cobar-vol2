...
matching Vol~I Theorem~\ref{V1-thm:bp-koszul-conductor-polynomial} .
\end{proposition}

\begin{proof}
The BP kappa is
$\kappaChHodge(\mathrm{BP}_k) = -(2k+3)(3k+1)/(2(k+3)) + \text{correction}$
obtained from \eqref{eq:bp-central-charge-FL} via
...
$\kappaChHodge(\mathrm{BP}_k) + \kappaChHodge(\mathrm{BP}_{-k-6}) \equiv 196$ is
...
$\kappaChHodge(\mathrm{BP}_k) + \kappaChHodge(\mathrm{BP}_{-k-6}) \equiv 196$
