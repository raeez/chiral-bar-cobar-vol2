...
part of this volume (cf.~\ref{part:holography})
...
$(Z^{\mathrm{der}}_{\mathrm{ch}}(\cA),\cA)$ carries the universal
mixed chiral-topological $\SCchtop$ datum through the heptagon. Fourth
(\S\ref{sec:chd-rigidity}), the consequence:
...
mixed chiral-topological structure on the derived-centre pair
$(Z^{\mathrm{der}}_{\mathrm{ch}}(\cA),\cA)$, not on $\cA$ alone. The
corrected reading applies Lemma~\ref{lem:chd-e3-rigidity-point} to
$Z^{\mathrm{der}}_{\mathrm{ch}}(\cA|_{D_x})$, not to
$\cA|_{D_x}$.

Step~2 asserted that chiral PBW collapse (Vol.~I,
Theorem~\ref*{V1-thm:pbw-koszulness-criterion}) identifies
...
Vol.~I~Theorem~\ref*{V1-thm:pbw-koszulness-criterion} and therefore not
...
Step 1: derived centre at the formal disc carries the mixed
chiral-topological datum. Fix a
...
Remark~\ref{rem:chd-native-vs-derived}) carries the mixed
chiral-topological
