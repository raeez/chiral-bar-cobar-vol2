...
in $\Bbbk$-chain complexes (in the sense of
Convention~\ref{conv:chd-e3-chiral-meaning}) by
Thm~\ref{thm:chiral-higher-deligne}(1). The relevant rigidity input is
...
the Koszul locus (Vol.~I,
Theorem~\ref*{thm:pbw-koszulness-criterion}) identifies
$\cA|_{D_x} = U_{E_3}(V_x)$ where $V_x$ is the space of
generators restricted to $D_x$, of polynomial growth (the growth
bound is the Hilbert-series bound $\alpha_\cA$ from Vol.~I,
landscape census entries for standard families).
...
Gerstenhaber algebras on cohomology). The $E_3$-extension of
Thm~\ref{thm:chiral-higher-deligne} then lifts uniquely (by
Part~(2) of that theorem, applied to both sides, in the sense of
Convention~\ref{conv:chd-e3-chiral-meaning}) to a quasi-isomorphism
of $E_3$-chiral algebras.
...
bar-cobar and DS BRST both converge.
\end{proof}
...
(Fresse, vol.~II, \S13); (b) chiral PBW collapse in the Koszul locus
