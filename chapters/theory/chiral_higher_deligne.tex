...
Thm~\ref{thm:chiral-higher-deligne}(1); its zeroth cohomology is
$H^0(Z^{\mathrm{der}}_{\mathrm{ch}}(\cA|_{D_x})) = \Bbbk$ (the centre
of an $E_1$-algebra over a field with unit $1\in\cA$ is $\Bbbk$ at
generic parameters; Francis, \emph{The tangent complex and
Hochschild cohomology of $E_n$-rings}, Compositio Math.~2013).
