...
been the residual obstruction to universal holography. Using
Theorem~\ref{thm:chd-ds-hochschild}, we reduce the
...
chain level across all four classes. The conditionality remark of
Chapter~\ref{ch:thqg-symplectic-polarization} should accordingly drop
the ``G/L/C proved; M conditional'' qualifier; the corrected
statement is ``G/L/C/M all chain-level proved on the Koszul locus at
generic level.''
\end{remark}
