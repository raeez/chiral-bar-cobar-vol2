...
ambient reconstitution) but was never inscribed as a standalone
...
Feynman transform; the bracket and differential are inscribed
...
Remark~\ref{rem:nc-wave15-DNA-Ainfty-open} and
...
\label{rem:cdhg-wave15-DNA-tower-bound}
...
\label{sec:cdhg-wave17-DNA}

\begin{remark}[Genus-$9$ and genus-$10$ obstructions via $\phi^{(8,9,10)}$]
\label{rem:cdhg-wave17-DNA-obs-9-10}
The Wave-$17$ coherences $\phi^{(8)}, \phi^{(9)}, \phi^{(10)}$
inscribed in Vol.~I
Remarks~\ref{rem:nc-wave17-DNA-phi8}--\ref{rem:nc-wave17-DNA-phi10}
...
\label{rem:cdhg-wave17-DNA-obs-infty}
Since the $A_\infty$-tower never closes (Vol.~I
Remark~\ref{rem:nc-wave17-DNA-asymptotic}: Borcherds leg dominates
...
Remark~\ref{rem:nc-wave17-DNA-obs-infty} and
\texttt{compute/lib/k3\_yangian\_wave17\_pentagon\_coboundary\_hbar8\_9\_10.py}.
...
\label{rem:cdhg-wave18-DNA-obs-10-11}
...
and lives on the full Sp_$4(\mathbb{Z})$ paramodular quotient, with
...
Cross-ref Vol.~I
Remark~\ref{rem:nc-wave18-DNA-phi12},
Vol.~III Remark~\ref{rem:cycainf-wave18-DNA-depth-4},
...
\label{rem:cdhg-wave18-DNA-ML-12}
The pro-limit
$\mathrm{obs}_\infty \in \varprojlim_{m}(\mathrm{tower}/W^{\ge m})$
...
Remark~\ref{rem:nc-wave18-DNA-ML-prolimit-12},
\texttt{compute/lib/k3\_yangian\_wave18\_pentagon\_coboundary\_hbar11\_12.py}.
...
\label{rem:cdhg-wave18-DNA-depth-4-grt1}
The first depth-$4$ irreducible MZV $\zeta(3, 3, 3, 3)$ enters
$\phi^{(12)}$ (Vol.~I Remark~\ref{rem:nc-wave18-DNA-phi12}) and
...
polynomial combinations of Wave-$17$ data.  Pattern~$277$ scope
...
Remark~\ref{rem:nc-wave18-DNA-grt1-weight-12}, Vol.~III
...
\label{rem:cdhg-wave18-DNA-fake-monster-non-interference}
