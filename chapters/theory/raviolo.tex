...
fields and their derivatives (hypothesis~(c)).  In the HT
...
(hypothesis~(b)) guarantees absolute convergence of the
...
\smallskip
\noindent\emph{Where the hypotheses are used.}
...
\phantomsection\label{sec:hypotheses-summary}
