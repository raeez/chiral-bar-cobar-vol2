...
Hodge-row anomaly
$\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$ \textup(per
...
$\kappaChHodge(\cA)\cdot\omega_g$; this scalar is not visible in the
formal-disc operad.
...
\[
 ...
 \;=\;
 \kappaChHodge(\hat\fg_k) \cdot \omega_1
 \;=\;
 \frac{(k+h^\vee)\,d}{2h^\vee} \cdot
 \frac{i}{2\operatorname{Im}\tau}\,
 dz \wedge d\bar z,
\]
confirming $\dfib^{\,2} = \kappaChHodge(\hat\fg_k)\cdot\omega_1$ with the
...
The curvature $\kappaChHodge(\hat\fg_k)\cdot\omega_1$ measures the
...
\end{equation}
the curvature $\dfib^{\,2} = \kappaChHodge(\mathrm{Vir}_c)\cdot\omega_1$.
...
\item \textbf{Curvature at genus $g \geq 1$.} At genus~$1$, and on
 ...
 $\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$ is
 ...
 $\kappaChHodge(\cA) \cdot \omega_g \in H^0(\Mbar_g, \omega_{\Mbar_g})$.
 ...
 scalar $\kappaChHodge(\cA)$ times the Hodge class
 ...
 $\kappaChHodge(\cA) \cdot \omega_g$ is the obstruction to
...
\begin{proof}[Proof sketch of $\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$]
...
\textup{(iii)} Curved geometric &
 $K^{(g)}_{\mathrm{Ar}}$ &
 $\dfib^{\,2} = \kappaChHodge \cdot \omega_g$ &
...
curvature $\kappaChHodge(\cA) \cdot \omega_g$.
...
\item \textbf{Range of equivalence.} The local-shadow functor is an
 ...
 monodromy, and the scalar anomaly $\kappaChHodge(\cA)\cdot\omega_g$.
\end{enumerate}
\end{theorem}
...
\item \textbf{Categorical placement.} At each genus~$g$, the
 ...
 \kappaChHodge \cdot \omega_g)$ belongs to the coderived category.
...
curved ($\dfib^{\,2} = \kappaChHodge \cdot \omega_g$), and cobar
...
\omega_g)$ lives in the coderived category. This is the
...
proved lane by $\kappaChHodge(\cA) \cdot \omega_g$.
\end{corollary}
...
has $\dfib^{\,2} = \kappaChHodge \cdot \omega_g$ at genus~$1$, and on the
...
$\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$ and verified it
...
$\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$ with the Arakelov form
...
\item \textbf{Curved Arakelov model.}
 ...
 $\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$ (it is a curved dg
 coalgebra).
\end{enumerate}
...
When $\dfib^{\,2}=\kappaChHodge(\cA)\omega_g\ne0$, the comparison
...
uncurved locus $\kappaChHodge(\cA)\omega_g=0$.
...
curved dg coalgebra ($\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$) and
...
The genus-$g$ bar complex with $\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g
...
\kappaChHodge(\cA) \cdot \omega_g)$ be the curved bar complex at genus~$g$
...
\item The curved bar complex $\barB^{(g)}(\cA)$ is a curved dg
 ...
 $\kappaChHodge(\cA) \cdot \omega_g$, and the structural relation is
...
degree~$+1$ and satisfies $\dfib^{\,2} = \kappaChHodge(\cA) \cdot \omega_g$
...
curvature datum $\kappaChHodge(\cA) \cdot \omega_g$. It is the algebra that
