...
pair $(\Zderch(A), A)$, never on $A$ alone). Three further
...
pentagon coherence treatment in preparation. The single-colour
...
projection it gives the Borcherds quantity $c_\Lambda(0)/2$. The same
...
Vol.~III two-stage factorisation; \ClaimStatusProvedElsewhere]
...
$\SpCh_{\Sigma_{d-1},C}$ may specialise. The $d = 2$ K3 case has
$\Sigma_1 = \R$ canonically and the family collapses to a single
pair $(\cA_\cC, \mathbf H_{\Delta_5})$; the $d = 3$ K3$\times E$
...
\section{Swiss-cheese factorisation at K3 x E}
\label{sec:fsc-new}
...
The Swiss-cheese BV partition function at $K3 \times T^2$ receives a paramodular anomaly contribution in $H^2(\overline{\mathcal{A}_2}, \mathcal{O}^*)$; the unique trivialiser (Deligne cohomology) is $\Delta_5$ of weight $5 = \chi(\mathcal{O}_{K3}) + \sum_{24} \mathrm{Res}(I_1) = 2 + 3$.
\end{remark}
...
itself (the K3 synthesis Nekrasov abelian-at-Lie correction).
\end{remark}
...
\begin{remark}[Factorisation Swiss-cheese and the GW/DT character on
...
potential). The factorisation-homology character of the closed colour,
summed over all arity strata of $\mathsf{SC}^{\mathrm{ch,top}}$, equals
the reduced Donaldson--Thomas generating function of $K3 \times E$:
\[
 \chi\bigl(\int_{\Ran(K3 \times E)}
 \mathsf{SC}^{\mathrm{ch,top}}_{\mathrm{closed}}\bigr)(\Omega)
 \;=\; \frac{1}{\Phi_{10}(\Omega)},
\]
by the Maulik--Nekrasov--Okounkov--Pandharipande GW/DT correspondence
(MNOP~I 2006, arXiv:math/0312059) combined with the Igusa cusp form
conjecture of Oberdieck--Pandharipande 2015 (arXiv:1411.1514) proved
unconditionally by Oberdieck--Pixton 2016 (arXiv:1706.10100). The
...
the character to the refined Igusa cusp form
$\Phi_{10}^{\mathrm{ref}}$ (Iqbal--Kozcaz--Vafa 2007,
