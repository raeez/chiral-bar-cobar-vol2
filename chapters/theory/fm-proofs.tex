...
Verification: the $n=3$ $A_\infty$ identity by computing the residue at each codimension-1 boundary divisor of $\FM_3(\C)$ and assembling the contributions via Stokes' theorem.
...
Carrying out the full boundary analysis for $\FM_4(\C)$, verifying the $n=4$ $A_\infty$ identity.
