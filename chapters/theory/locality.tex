...
The space $\Conf_n(\C)$ is a smooth manifold of real dimension $2n$, noncompact.  Integration of differential forms over $\Conf_n(\C)$ — which is how chiral OPE residues are extracted — requires a compactification that records the relative rates at which points approach each other.  The Fulton--MacPherson compactification \cite{FM94} is the canonical choice:
