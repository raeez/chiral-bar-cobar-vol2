...
the two-coloured Swiss-cheese coalgebra attached to~$\cA$ by the
Koszul dual cooperad $(\SCchtop)^{\text{\raisebox{0.5pt}{\fontsize{5pt}{5pt}\selectfont !}}}$: the closed
sector classifies chiral twisting morphisms, the open sector
classifies ordered (associative) ones, and the mixed sector encodes
bulk-to-boundary intertwiners.  The ordered-to-symmetric descent
...
obstruction tower of Volume~I is the genus- and arity-graded
...
The $\SCchtop$ operad is the single source of all three bar
complexes catalogued in \S\ref{sec:bar_cobar}
...
not independent constructions; they are the closed-colour,
closed-colour-averaged, and open-colour projections of the
single $\SCchtop$-bar coalgebra
$\barB^{\SCchtop}(\cA)$.  The
...
the full $\SCchtop$-structure developed in
Chapter~\ref{ch:factorization-swiss-cheese} is the ordered ancestor
...
(Theorem~\ref*{V1-thm:mc2-bar-intrinsic}).  The full
$\SCchtop$-bar coalgebra $\barB^{\SCchtop}(\cA)$ carries
