...
Write $\rho_K(\cA) := \kappaChHodge(\cA) + \kappa(\cA^!)$ for the Koszul
...
$\kappaChHodge(\cA) + \kappa(\cA^!) = \rho_K$ and the
...
$\kappaChHodge(\cA) + \kappa(\cA^!) = \rho_K$ exploited below; while
...
The Koszul conductor $\rho_K(\cA) = \kappaChHodge(\cA) + \kappa(\cA^!)$
...
$d^2 = \kappaChHodge(\cA) \cdot \omega_g$ on the uniform-weight locus
