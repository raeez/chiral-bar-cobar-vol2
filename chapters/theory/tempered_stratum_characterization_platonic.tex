...
\textsf{thm:shadow-tower-asymptotic-closed-form} (Vol~I
...
\end{itemize}
Conjecture~\ref{thm:beta-N-closed-form-proved-all-N} delivers the
...
quadratic-Koszul. The shadow tower acquires factorially growing
log-modular coefficients on the logarithmic loci (Flohr 1996;
Adamovic--Milas 2009), placing $\cW(p)$ outside the tempered stratum.
...
$\bbZ/2$-orbifolds; (ii) Monster-type VOAs (twisted sectors of
...
The logarithmic $\cW(p)$ and Monster-type statements require the
Adamovic--Milas generator count and the
Frenkel--Lepowsky--Meurman twisted-sector analysis respectively.
\end{proof}

\section{Independent verification summary}
\label{sec:tempered-stratum-iv-summary}

The theorems admit the following independent-verification structure,
implemented in
\texttt{compute/tests/test\_tempered\_stratum.py} along disjoint
derivation and verification paths.
...
\item \textbf{Cross-links}: Vol~I
 ...
 and the chain-level $E_3$ theorem under $(\mathrm{H}_S)$; Vol~II
