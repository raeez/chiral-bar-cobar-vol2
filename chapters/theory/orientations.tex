...
The computation of the orientation signs $\epsilon_F$ for all codimension-1 boundary faces of $\FM_3(\C)$ in complete detail.
...
Verification: $d\omega = 0$. Since $d\log f$ is closed ($d(d\log f) = d(df/f) = 0$ away from $\{f=0\}$), and the wedge product of closed forms is closed:
\[
