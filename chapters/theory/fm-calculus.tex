...
\section{Wave~14 Costello DNA: FM calculus and twisted-holography KK matching on K3}
...
operations $\{m_k\}$. A Wave~14 adversarial cycle
...
subsumes the other (Pattern 236 ambient-qualifier discipline).
\end{remark}

\section{Wave 13 DNA perspective}
\label{sec:fmc-wave13-DNA}

\begin{remark}[FM calculus at the Wave~13 K3 base point]
\label{rem:fmc-DNA-1}
