...
This section provides the geometric engine underlying $A_\infty$ chiral algebras: we prove the $A_\infty$ Stasheff identities (\ref{eq:ainfty-relation-raw}) using Stokes' theorem on Fulton--MacPherson compactifications, with codimension-2 corners canceling via Arnold--Orlik--Solomon relations.
...
\begin{lemma}[Arnold Cancellation at Corners]
...
\begin{theorem}[Cluster Factorization Identity]
...
\begin{proposition}[Explicit Formula for $m_2$]
