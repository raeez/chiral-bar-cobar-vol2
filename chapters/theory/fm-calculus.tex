...
\item The three pairwise collision divisors\/ $D_{\{i,j\}} \subset \partial\FM_3(\C)$ meet in codimension-$2$ corners whose intersection numbers, computed via the symplectic orientation, sum to zero.  This vanishing is the $(-1)$-shifted Poincar\'{e} duality of the correspondence: the Arnold relation is the degree-$(-1)$ analogue of the classical Poincar\'{e} duality pairing on a compact manifold.
