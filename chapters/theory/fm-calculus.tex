...
\begin{lemma}[Arnold cancellation at FM-log corners; \ClaimStatusProvedHere]
...
\begin{proposition}[Arnold cancellation as $(-1)$-shifted Poincar\'{e}
duality; \ClaimStatusHeuristic]
...
\begin{proof}[Heuristic verification]
...
\begin{theorem}[FM boundary cluster factorization; \ClaimStatusProvedHere]
...
realization; \ClaimStatusConditional]
...
\begin{proposition}[FM model for the 24-point K3 discriminant;
...
\begin{proof}[Heuristic comparison]
...
$\chi(\mathrm{K3}) = 24$ anomaly; \ClaimStatusConditional,
chain-level]
...
Proposition~\ref{thm:fm-24-node-stratum}. Then the Green--Schwarz
...
(pair-collisions). By
Proposition~\ref{thm:fm-24-node-stratum}, the 12 pair-collision
...
Proposition~\ref{thm:fm-24-node-stratum} halves this to 12
...
sign rule; \ClaimStatusConditional, chain-level]
\label{prop:fm-umbral-z6-sign}
\index{umbral moonshine!$\mathbb Z/6$ sign rule}
Assume the compute module cited in the proof and the Vol.~III
comparison with the umbral Schur cocycle. Let $g\in M_{24}$ be an
