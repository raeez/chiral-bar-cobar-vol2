...
\begin{lemma}[QME implies $A_\infty$ relations; \ClaimStatusConditional]
...
Theorem~\ref{thm:scchtop-bar-cobar-adjunction}, the bar--cobar adjunction
\[
 \Omega \colon
...
Ch.\,\ref{V3-ch:k3-chiral-bialgebra-platonic}, fits the axiomatic
...
Theorem~\textup{\ref{V1-thm:theorem-h-platonic-pointer}}\textup{)}.
