...
$\mathcal W_N$ analogue of de~Boer--Tjin and Bouwknegt--McCarthy--Pilch.
...
Every Sugawara-type invariant therefore has \emph{two companion
theorems}
...
The K3 comparison is tight only if
$\ChirHoch^3\bigl(\mathbf{H}_{\Delta_5}\bigr) \neq 0$ survives the
finite CoHA, radical, parity, completion, and inverse-limit gates; the
candidate class is represented chain-level by the Schiffmann--Vasserot
degree-$3$ CoHA generator in the Borcherds imaginary-root direction.
