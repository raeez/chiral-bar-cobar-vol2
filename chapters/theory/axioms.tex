...
Quillen equivalence states that these three determinations
--- Lagrangian, groupoid, SC-algebra --- are equivalent data:
a Lagrangian determines its groupoid, which determines its
SC-algebra, which determines the Lagrangian, and this circle
closes by the universal property of the bar-cobar adjunction.
\end{proof}
