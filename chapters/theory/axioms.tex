...
\begin{remark}[Vol~II axioms of $\mathsf{SC}^{\mathrm{ch,top}}$ at the Wave~13 K3 base point]
\label{rem:axioms-DNA-1}
The Vol~II axioms of $\mathsf{SC}^{\mathrm{ch,top}}$ ($3$D HT QFT)
instantiate at the Wave~13 K3 base point with: chiral algebra
$\mathbf H_{\Delta_5}$ at the Schur sector of class-$\mathcal S$ $A_1$
on $\Sigma_{0,24}$, central charges $c_{4d} = 26, c_{2d} = -312$,
...
\begin{remark}[Wave~13 axiomatic refinement]
\label{rem:axioms-DNA-2}
At the Wave~13 K3 base point, the Vol~II axioms refine: (i) factorisation
...
2013. The universal identity is the Wave~13 axiom (v) that ties (i)-(iv)
