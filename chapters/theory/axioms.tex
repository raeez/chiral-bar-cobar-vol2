...
Assume {\rm (H1)--(H4)} (Hypotheses~\ref{hyp:H1}--\ref{hyp:H3} and Assumption~\ref{ass:H1-H4}).
...
Under Hypotheses {\rm (H1)--(H4)}, our Definition \ref{def:ainfty_chiral} correctly formalizes the $A_\infty$ chiral algebra structure implicit in Costello--Gwilliam--Gaiotto--Dimofte for the following reasons:
...
\item \textbf{Consistency with dimensional ascent:} Our definition generalizes Tamarkin's chiral Hochschild complex \cite{Tam03} and provides the 3d analogue of 2d Hochschild theory from Poisson sigma models (Section \ref{sec:chiral_hochschild_expanded}).
\end{enumerate}
\end{proposition}
