...
\item \emph{Stage~$7$}: the modular extension
 ...
 $d_{\barB}^2 = \kappa(\cA) \cdot \omega_g$ at genus $g \ge 1$.
 The modular characteristic $\kappa(\cA)$ is the leading
