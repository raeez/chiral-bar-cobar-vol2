...
\end{proposition}
\begin{proof}
Use cover descent and the standard argument for factorization algebras; cf.\ \cite{CG17,GarnerWilliams2023}.
\end{proof}
...
Under Hypotheses \textrm{(H1)--(H4)}, for HT twists of 3d $\mathcal N=2,4$ theories, $H^\bullet(\mathsf V_{\mathrm{rav}})$ agrees with the PVA extracted by the secondary products in \cite{OY20,CDG20} and the 2–shifted Poisson structures in \cite{GarnerWilliams2023,GarnerRaghavendranWilliams2023}.
\end{corollary}
