...
Under Hypotheses {\rm (H1)--(H4)}, for HT twists of 3d $\mathcal N=2,4$ theories, $H^\bullet(\mathsf V_{\mathrm{rav}})$ agrees with the PVA extracted by the secondary products in \cite{OY20,CDG20} and the 2–shifted Poisson structures in \cite{GarnerWilliams2023,GarnerRaghavendranWilliams2023}.
\end{corollary}
