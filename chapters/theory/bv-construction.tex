...
identification depends on the harmonic-decoupling
property: the BV propagator splits into a holomorphic kernel and a
topological kernel without cross-coupling at the harmonic component, established for class G/L by the explicit
Wakimoto / free-field realisation and conjectural for class C/M at
chain level. The cohomological identification
...
C/M closes in the weight-completed category by
...
class G/L and on class C/M in the
