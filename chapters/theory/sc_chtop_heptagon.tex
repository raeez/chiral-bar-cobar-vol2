...
\emph{not} an object of $\cZ(\Rep_{\mathrm{fact}}(\cA))$, reflecting
the categorical-level distinction that $\cA$ is $E_1$-chiral while
the Drinfeld centre is a braided $\infty$-category one level up;
