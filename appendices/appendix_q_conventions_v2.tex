...
bridge with AP126 verification at $k=0$, R-matrix monodromy, conformal weights at
q-deformation, categorical agreement). The Chriss--Ginzburg form
...
incompatible normalisations of $\hbar$ had coexisted (an instance of AP151).
...
of the cascade error FM24 and the BCFG within-file clash below.
\end{remark}
...
unity into a real exponential decay. This is FM24 / AP151.
...
neutralises are: FM24 (B-cycle $i^{2}$ error); AP151 (within-file hbar clash);
AP-CY25 (R-matrix from $\Delta(1)$); AP-CY26 (Verdier $k^{!}=-k$ vs
$\sigma_{2}$); AP156 (Weierstrass $\wp_{1}$ periodic vs quasi-periodic). The
zoo in \S\ref{sec:hbar-zoo-vol2} supplies a named symbol for every occurrence
so that none of these conflations can silently recur.
\end{remark}
