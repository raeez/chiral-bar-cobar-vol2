...
We project both sides to the ``mixed'' component where the outer operation contributes the regular part (product) and the inner contributes the singular part (bracket), or vice versa.
