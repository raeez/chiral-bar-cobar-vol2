...
- **R1. Scalar target invariant.** Conditional on finite Hall--Borcherds source recognition, the Vol II quantum-group lane targets the scalar Borcherds comparator line $\mathbb{C}\cdot\Delta_5$; the displayed $H^2(\mathfrak{g}_{\Delta_5})^{\mathbb{Z}/2,\,K(1)}$ classification is a Vol III recognition gate, not a direct Vol II classification.
