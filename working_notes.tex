...
(\S\ref{sec:primitive-coproduct}): the algebraic shadow has no
splitting coproduct.
...
$r$-matrix & $r_{\mathrm{OPE}}=k\,\Omega/z$; $r_{\mathrm{KZ}}=\Omega/((k+2)z)$; $r_{\mathrm{Y}}=\hbar\Omega/z$ \\
...
\begin{proposition}[Conditional classification of uncurved-but-nontrivial algebras;
...
\\
$r$-matrix
& Simple pole: $r(z) = k\,\Omega/z$ \textup{(trace convention)}
