...
.PHONY: all fast clean veryclean clean-builds count check test dist release help working-notes standalone icloud verify-independence verify-independence-verbose verify-licensing verify-licensing-report mathematics-publish root-publish architecture unified-architecture
