...
### E_1-Chiral Notions: Collapse to Two on the Koszul Locus

Five presentations circulate: (A) strict ChirAss-algebra, (B) A_inf in End^{ch}_A, (C) EK quantum vertex algebra, (D) A_inf in E_1-chiral, (E) factorization on Ran^{ord}(X). HEALED 2026-04-17: on the Koszul locus, (A), (B), (C), (E) are mutually Quillen-equivalent via Stasheff strict/A_inf truncation + Etingof-Kazhdan + Beilinson-Drinfeld D-module realization; see Vol I `thm:e1-chiral-notions-collapse` in `chapters/theory/algebraic_foundations.tex`. Only (D) double-A_inf remains genuinely distinct (open: `conj:double-ainfty-notion-D-relation`). Operational registry is two: ordinary E_1-chiral input + speculative (∞,2)-enhancement. The presentations (A)/(B)/(C)/(E) are retained as technical inputs for specific diagrammatic constructions; the collapsed homotopy type is a single category of inputs.
...
- AP161: Five presentations of E_1-chiral algebra HEALED 2026-04-17 to two on Koszul locus via Vol I `thm:e1-chiral-notions-collapse`: (A)/(B)/(C)/(E) mutually Quillen-equivalent; only (D) double-A_inf remains distinct (`conj:double-ainfty-notion-D-relation`). Operational registry: ordinary E_1-chiral input + speculative (∞,2)-enhancement. Outside the Koszul locus the original AP161 separation still applies; inside, transport inputs freely via the Quillen equivalences.
